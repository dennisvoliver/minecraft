...
public class ConnectScreen extends Screen {
   ...
   private void connect(final String address, final int port) {
      LOGGER.info((String)"Connecting to {}, {}", (Object)address, (Object)port);
      Thread thread = new Thread("Server Connector #" + CONNECTOR_THREADS_COUNT.incrementAndGet()) {
         public void run() {
            ...
            try {
               ...
               ConnectScreen.this.connection.setPacketListener(new ClientLoginNetworkHandler(ConnectScreen.this.connection, ConnectScreen.this.client, ConnectScreen.this.parent, (text) -> {
               ...
               ConnectScreen.LOGGER.error((String)"Couldn't connect to server", (Throwable)var4);
               ConnectScreen.this.client.execute(() -> {
                  ConnectScreen.this.client.openScreen(new DisconnectedScreen(ConnectScreen.this.parent, ScreenTexts.CONNECT_FAILED, new TranslatableText("disconnect.genericReason", new Object[]{"Unknown host"})));
               });
               ...
               ConnectScreen.LOGGER.error((String)"Couldn't connect to server", (Throwable)var5);
               String string = inetAddress == null ? var5.toString() : var5.toString().replaceAll(inetAddress + ":" + port, "");
               ConnectScreen.this.client.execute(() -> {
                  ConnectScreen.this.client.openScreen(new DisconnectedScreen(ConnectScreen.this.parent, ScreenTexts.CONNECT_FAILED, new TranslatableText("disconnect.genericReason", new Object[]{string})));
               });
            }
