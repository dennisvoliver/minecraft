...
public class ZombieSiegeManager implements Spawner {
   ...
   private void trySpawnZombie(ServerWorld world) {
      ...
      if (vec3d != null) {
         ...
         try {
            zombieEntity2 = new ZombieEntity(world);
            zombieEntity2.initialize(world, world.getLocalDifficulty(zombieEntity2.getBlockPos()), SpawnReason.EVENT, (EntityData)null, (CompoundTag)null);
         } catch (Exception var5) {
            field_26390.warn((String)"Failed to create zombie for village siege at {}", (Object)vec3d, (Object)var5);
            return;
         }
