...
public class AffineTransformations {
   ...
   public static final EnumMap<Direction, AffineTransformation> DIRECTION_ROTATIONS = (EnumMap)Util.make(Maps.newEnumMap(Direction.class), (enumMap) -> {
      ...
      enumMap.put(Direction.EAST, new AffineTransformation((Vector3f)null, new Quaternion(new Vector3f(0.0F, 1.0F, 0.0F), 90.0F, true), (Vector3f)null, (Quaternion)null));
      enumMap.put(Direction.WEST, new AffineTransformation((Vector3f)null, new Quaternion(new Vector3f(0.0F, 1.0F, 0.0F), -90.0F, true), (Vector3f)null, (Quaternion)null));
      enumMap.put(Direction.NORTH, new AffineTransformation((Vector3f)null, new Quaternion(new Vector3f(0.0F, 1.0F, 0.0F), 180.0F, true), (Vector3f)null, (Quaternion)null));
      enumMap.put(Direction.UP, new AffineTransformation((Vector3f)null, new Quaternion(new Vector3f(1.0F, 0.0F, 0.0F), -90.0F, true), (Vector3f)null, (Quaternion)null));
      enumMap.put(Direction.DOWN, new AffineTransformation((Vector3f)null, new Quaternion(new Vector3f(1.0F, 0.0F, 0.0F), 90.0F, true), (Vector3f)null, (Quaternion)null));
   });
   ...
   public static AffineTransformation uvLock(AffineTransformation affineTransformation, Direction direction, Supplier<String> supplier) {
      ...
      if (affineTransformation2 == null) {
         ...
         return new AffineTransformation((Vector3f)null, (Quaternion)null, new Vector3f(0.0F, 0.0F, 0.0F), (Quaternion)null);
      } else {
