...
public class RandomBooleanFeature extends Feature<RandomBooleanFeatureConfig> {
   ...
   public boolean generate(StructureWorldAccess structureWorldAccess, ChunkGenerator chunkGenerator, Random random, BlockPos blockPos, RandomBooleanFeatureConfig randomBooleanFeatureConfig) {
      ...
      return bl ? ((ConfiguredFeature)randomBooleanFeatureConfig.featureTrue.get()).generate(structureWorldAccess, chunkGenerator, random, blockPos) : ((ConfiguredFeature)randomBooleanFeatureConfig.featureFalse.get()).generate(structureWorldAccess, chunkGenerator, random, blockPos);
   }
}
