...
public class TutorialManager {
   ...
   public void method_31364(TutorialToast tutorialToast) {
      this.field_26893.removeIf((arg) -> {
         return arg.field_26894 == tutorialToast;
      });
      tutorialToast.hide();
   }

   public void tick() {
      this.field_26893.removeIf((object) -> {
         return ((TutorialManager.class_5524)object).method_31368();
      });
      if (this.currentHandler != null) {
