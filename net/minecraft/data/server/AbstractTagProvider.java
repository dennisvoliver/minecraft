...
public abstract class AbstractTagProvider<T> implements DataProvider {
   ...
   public void run(DataCache cache) {
      ...
      Function<Identifier, T> function2 = (identifier) -> {
         return this.registry.getOrEmpty(identifier).orElse((Object)null);
      };
      this.tagBuilders.forEach((identifier, builder) -> {
         ...
         if (!list.isEmpty()) {
            ...
            try {
               ...
               LOGGER.error((String)"Couldn't save tags to {}", (Object)path, (Object)var24);
            }
   ...
   protected Tag.Builder method_27169(Tag.Identified<T> identified) {
      return (Tag.Builder)this.tagBuilders.computeIfAbsent(identified.getId(), (identifier) -> {
   ...
   public static class ObjectBuilder<T> {
      ...
      public final AbstractTagProvider.ObjectBuilder<T> add(T... objects) {
         ...
         Registry var10001 = this.field_23961;
         var10001.getClass();
         var10000.map(var10001::getId).forEach((identifier) -> {
            this.field_23960.add(identifier, this.field_23962);
         });
         return this;
      }
   }
