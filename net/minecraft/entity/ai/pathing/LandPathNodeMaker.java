   ...
   private PathNode getPathNode(int x, int y, int z, int maxYStep, double prevFeetY, Direction direction, PathNodeType pathNodeType) {
      ...
      if (d - prevFeetY > 1.125D) {
         ...
         if (pathNodeType2 == PathNodeType.WALKABLE) {
            ...
            if ((pathNode == null || pathNode.penalty < 0.0F) && maxYStep > 0 && pathNodeType2 != PathNodeType.FENCE && pathNodeType2 != PathNodeType.UNPASSABLE_RAIL && pathNodeType2 != PathNodeType.TRAPDOOR) {
