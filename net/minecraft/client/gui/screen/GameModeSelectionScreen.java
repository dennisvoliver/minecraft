...
public class GameModeSelectionScreen extends Screen {
   ...
   private final Optional<GameModeSelectionScreen.GameMode> currentGameMode = GameModeSelectionScreen.GameMode.of(this.getPreviousGameMode());
   ...
   protected void init() {
      super.init();
      this.gameMode = this.currentGameMode.isPresent() ? this.currentGameMode : GameModeSelectionScreen.GameMode.of(this.client.interactionManager.getCurrentGameMode());
   ...
   public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
      if (!this.checkForClose()) {
         ...
         this.gameMode.ifPresent((gameMode) -> {
            drawCenteredText(matrices, this.textRenderer, gameMode.getText(), this.width / 2, this.height / 2 - 30 - 20, -1);
         });
         ...
         while(var8.hasNext()) {
            GameModeSelectionScreen.ButtonWidget buttonWidget = (GameModeSelectionScreen.ButtonWidget)var8.next();
