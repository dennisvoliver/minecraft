...
public class ChatMessages {
   private static final OrderedText field_25263;
   ...
   public static List<OrderedText> breakRenderedChatMessageLines(StringVisitable stringVisitable, int width, TextRenderer textRenderer) {
      ...
      return list.isEmpty() ? Lists.newArrayList((Object[])(OrderedText.EMPTY)) : list;
   }

   static {
      field_25263 = OrderedText.styled(32, Style.EMPTY);
   }
}
