...
public class WorldSaveHandler {
   ...
   public void savePlayerData(PlayerEntity playerEntity) {
      try {
         ...
         LOGGER.warn((String)"Failed to save player data for {}", (Object)playerEntity.getName().getString());
      }
   ...
   public CompoundTag loadPlayerData(PlayerEntity playerEntity) {
      ...
      try {
         ...
         LOGGER.warn((String)"Failed to load player data for {}", (Object)playerEntity.getName().getString());
      }
