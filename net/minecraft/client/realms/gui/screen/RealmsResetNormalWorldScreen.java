...
public class RealmsResetNormalWorldScreen extends RealmsScreen {
   ...
   public void init() {
      ...
      this.seedEdit = new TextFieldWidget(this.client.textRenderer, this.width / 2 - 100, row(2), 200, 20, (TextFieldWidget)null, new TranslatableText("mco.reset.world.seed"));
      ...
      this.addButton(new ButtonWidget(this.width / 2 - 102, row(12), 97, 20, this.field_24206, (buttonWidget) -> {
         this.parent.resetWorld(new RealmsResetWorldScreen.ResetWorldInfo(this.seedEdit.getText(), this.levelTypeIndex, this.generateStructures));
      }));
      this.addButton(new ButtonWidget(this.width / 2 + 8, row(12), 97, 20, ScreenTexts.BACK, (buttonWidget) -> {
