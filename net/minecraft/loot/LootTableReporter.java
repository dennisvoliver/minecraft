...
public class LootTableReporter {
   ...
   public LootTableReporter makeChild(String name) {
      ...
      }, this.contextType, this.conditionGetter, this.conditions, this.tableGetter, this.tables);
   }

   public LootTableReporter withTable(String name, Identifier id) {
      ImmutableSet<Identifier> immutableSet = ImmutableSet.builder().addAll((Iterable)this.tables).add((Object)id).build();
      return new LootTableReporter(this.messages, () -> {
         return this.getName() + name;
      }, this.contextType, this.conditionGetter, this.conditions, this.tableGetter, immutableSet);
   }

   public LootTableReporter withCondition(String name, Identifier id) {
      ImmutableSet<Identifier> immutableSet = ImmutableSet.builder().addAll((Iterable)this.conditions).add((Object)id).build();
      return new LootTableReporter(this.messages, () -> {
         return this.getName() + name;
      }, this.contextType, this.conditionGetter, immutableSet, this.tableGetter, this.tables);
   }
