...
public class RealmsPersistence {
   ...
   public static RealmsPersistence.RealmsPersistenceData readFile() {
      ...
      try {
         return (RealmsPersistence.RealmsPersistenceData)CHECKED_GSON.fromJson(FileUtils.readFileToString(file, StandardCharsets.UTF_8), RealmsPersistence.RealmsPersistenceData.class);
