...
public class RandomChanceWithLootingLootCondition implements LootCondition {
   ...
   public static class Serializer implements JsonSerializer<RandomChanceWithLootingLootCondition> {
      public void toJson(JsonObject jsonObject, RandomChanceWithLootingLootCondition randomChanceWithLootingLootCondition, JsonSerializationContext jsonSerializationContext) {
         jsonObject.addProperty("chance", (Number)randomChanceWithLootingLootCondition.chance);
         jsonObject.addProperty("looting_multiplier", (Number)randomChanceWithLootingLootCondition.lootingMultiplier);
      }
