...
public class CaveDebugRenderer implements DebugRenderer.Renderer {
   ...
   public void render(MatrixStack matrices, VertexConsumerProvider vertexConsumers, double cameraX, double cameraY, double cameraZ) {
      ...
      Iterator var12 = this.field_4507.entrySet().iterator();

      while(var12.hasNext()) {
         Entry<BlockPos, BlockPos> entry = (Entry)var12.next();
      ...
      var12 = this.field_4506.iterator();

      while(var12.hasNext()) {
         BlockPos blockPos4 = (BlockPos)var12.next();
         if (blockPos.isWithinDistance(blockPos4, 160.0D)) {
