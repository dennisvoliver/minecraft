...
public class AdvancementWidget extends DrawableHelper {
   ...
   public void drawTooltip(MatrixStack matrices, int x, int y, float alpha, int i, int j) {
      ...
      int var10000 = 113 - y - this.yPos - 26;
      ...
      this.drawTexture(matrices, x + this.xPos + 3, y + this.yPos, this.display.getFrame().getTextureV(), 128 + advancementObtainedStatus12.getSpriteIndex() * 26, 26, 26);
      if (bl) {
         this.client.textRenderer.drawWithShadow(matrices, (OrderedText)this.title, (float)(p + 5), (float)(y + this.yPos + 9), -1);
         if (string != null) {
            this.client.textRenderer.drawWithShadow(matrices, (String)string, (float)(x + this.xPos - k), (float)(y + this.yPos + 9), -1);
         }
      } else {
         this.client.textRenderer.drawWithShadow(matrices, (OrderedText)this.title, (float)(x + this.xPos + 32), (float)(y + this.yPos + 9), -1);
         if (string != null) {
            this.client.textRenderer.drawWithShadow(matrices, (String)string, (float)(x + this.xPos + this.width - k - 5), (float)(y + this.yPos + 9), -1);
         }
      }
