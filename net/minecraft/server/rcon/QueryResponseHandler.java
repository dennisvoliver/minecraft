...
public class QueryResponseHandler extends RconBase {
   ...
   private QueryResponseHandler(DedicatedServer server, int queryPort) {
      ...
      if (!this.hostname.isEmpty() && !this.ip.equals(this.hostname)) {
         ...
         try {
            ...
            field_23963.warn((String)"Unable to determine local host IP, please set server-ip in server.properties", (Throwable)var4);
         }
      }
   ...
   public static QueryResponseHandler create(DedicatedServer server) {
      ...
      if (0 < i && 65535 >= i) {
         ...
         field_23963.warn((String)"Invalid query port {} found in server.properties (queries disabled)", (Object)i);
         return null;
      }
   }
   ...
   private boolean handle(DatagramPacket packet) throws IOException {
      ...
      field_23963.debug((String)"Packet len {} [{}]", (Object)i, (Object)socketAddress);
      if (3 <= i && -2 == bs[0] && -3 == bs[1]) {
         field_23963.debug((String)"Packet '{}' [{}]", (Object)BufferHelper.toHex(bs[2]), (Object)socketAddress);
         switch(bs[2]) {
         case 0:
            if (!this.isValidQuery(packet)) {
               field_23963.debug((String)"Invalid challenge [{}]", (Object)socketAddress);
               return false;
            } else if (15 == i) {
               this.reply(this.createRulesReply(packet), packet);
               field_23963.debug((String)"Rules [{}]", (Object)socketAddress);
            } else {
               ...
               field_23963.debug((String)"Status [{}]", (Object)socketAddress);
            }
         default:
            return true;
         case 9:
            this.createQuery(packet);
            field_23963.debug((String)"Challenge [{}]", (Object)socketAddress);
            return true;
         }
      } else {
         field_23963.debug((String)"Invalid packet [{}]", (Object)socketAddress);
         return false;
      }
   }
   ...
   public void run() {
      field_23963.info((String)"Query running on {}:{}", (Object)this.hostname, (Object)this.queryPort);
      ...
      try {
         ...
         field_23963.debug((String)"closeSocket: {}:{}", (Object)this.hostname, (Object)this.queryPort);
         this.socket.close();
      }
   ...
   private void handleIoException(Exception e) {
      if (this.running) {
         field_23963.warn((String)"Unexpected exception", (Throwable)e);
         if (!this.initialize()) {
   ...
   private boolean initialize() {
      try {
         ...
         field_23963.warn((String)"Unable to initialise query system on {}:{}", (Object)this.hostname, this.queryPort, var2);
         return false;
      }
   }
