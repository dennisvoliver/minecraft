...
public class HideInHomeTask extends Task<LivingEntity> {
   ...
   protected boolean shouldRun(ServerWorld world, LivingEntity entity) {
      Optional<BlockPos> optional = world.getPointOfInterestStorage().getPosition((pointOfInterestType) -> {
         ...
         return true;
      }, entity.getBlockPos(), this.preferredDistance + 1, PointOfInterestStorage.OccupationStatus.ANY);
   ...
   protected void run(ServerWorld world, LivingEntity entity, long time) {
      ...
      if (optional.isPresent()) {
         ...
         brain.remember(MemoryModuleType.HIDING_PLACE, (Object)GlobalPos.create(world.getRegistryKey(), (BlockPos)optional.get()));
         if (!((BlockPos)optional.get()).isWithinDistance(entity.getPos(), (double)this.preferredDistance)) {
            brain.remember(MemoryModuleType.WALK_TARGET, (Object)(new WalkTarget((BlockPos)optional.get(), this.walkSpeed, this.preferredDistance)));
         }
      }
