...
public abstract class FoliagePlacer {
   ...
   protected static <P extends FoliagePlacer> P2<Mu<P>, UniformIntDistribution, UniformIntDistribution> fillFoliagePlacerFields(Instance<P> instance) {
      return instance.group(UniformIntDistribution.createValidatedCodec(0, 8, 8).fieldOf("radius").forGetter((foliagePlacer) -> {
         return foliagePlacer.radius;
      }), UniformIntDistribution.createValidatedCodec(0, 8, 8).fieldOf("offset").forGetter((foliagePlacer) -> {
