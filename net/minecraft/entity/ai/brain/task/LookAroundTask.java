...
public class LookAroundTask extends Task<MobEntity> {
   ...
   protected boolean shouldKeepRunning(ServerWorld serverWorld, MobEntity mobEntity, long l) {
      return mobEntity.getBrain().getOptionalMemory(MemoryModuleType.LOOK_TARGET).filter((lookTarget) -> {
   ...
   protected void keepRunning(ServerWorld serverWorld, MobEntity mobEntity, long l) {
      mobEntity.getBrain().getOptionalMemory(MemoryModuleType.LOOK_TARGET).ifPresent((lookTarget) -> {
