...
public class SmithingRecipeJsonFactory {
   ...
   public void offerTo(Consumer<RecipeJsonProvider> exporter, Identifier recipeId) {
      ...
      exporter.accept(new SmithingRecipeJsonFactory.SmithingRecipeJsonProvider(recipeId, this.serializer, this.base, this.addition, this.result, this.builder, new Identifier(recipeId.getNamespace(), "recipes/" + this.result.getGroup().getName() + "/" + recipeId.getPath())));
   }
