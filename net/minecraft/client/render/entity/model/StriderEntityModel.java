...
public class StriderEntityModel<T extends StriderEntity> extends CompositeEntityModel<T> {
   ...
   public void setAngles(StriderEntity striderEntity, float f, float g, float h, float i, float j) {
      ...
      if (striderEntity.getPassengerList().size() <= 0) {
         this.field_23355.pitch = j * 0.017453292F;
         this.field_23355.yaw = i * 0.017453292F;
      } else {
      ...
      ModelPart var10000 = this.field_23355;
      var10000.pivotY -= 2.0F * MathHelper.cos(f * 1.5F) * 2.0F * g;
      this.field_23354.pitch = MathHelper.sin(f * 1.5F * 0.5F) * 2.0F * g;
      this.field_23353.pitch = MathHelper.sin(f * 1.5F * 0.5F + 3.1415927F) * 2.0F * g;
      this.field_23354.roll = 0.17453292F * MathHelper.cos(f * 1.5F * 0.5F) * g;
      this.field_23353.roll = 0.17453292F * MathHelper.cos(f * 1.5F * 0.5F + 3.1415927F) * g;
      this.field_23354.pivotY = 8.0F + 2.0F * MathHelper.sin(f * 1.5F * 0.5F + 3.1415927F) * 2.0F * g;
