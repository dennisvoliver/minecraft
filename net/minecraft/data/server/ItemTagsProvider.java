...
public class ItemTagsProvider extends AbstractTagProvider<Item> {
   ...
   protected void configure() {
      ...
      this.getOrCreateTagBuilder(ItemTags.MUSIC_DISCS).addTag(ItemTags.CREEPER_DROP_MUSIC_DISCS).add((Object)Items.MUSIC_DISC_PIGSTEP);
      ...
      this.getOrCreateTagBuilder(ItemTags.STONE_TOOL_MATERIALS).add((Object[])(Items.COBBLESTONE, Items.BLACKSTONE));
      this.getOrCreateTagBuilder(ItemTags.STONE_CRAFTING_MATERIALS).add((Object[])(Items.COBBLESTONE, Items.BLACKSTONE));
   }
