...
public class RecipeAlternativesWidget extends DrawableHelper implements Drawable, Element {
   ...
   public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
      if (this.visible) {
         ...
         Iterator var12 = this.alternativeButtons.iterator();

         while(var12.hasNext()) {
            RecipeAlternativesWidget.AlternativeButtonWidget alternativeButtonWidget = (RecipeAlternativesWidget.AlternativeButtonWidget)var12.next();
   ...
   class AlternativeButtonWidget extends AbstractButtonWidget implements RecipeGridAligner<Ingredient> {
      ...
      public void renderButton(MatrixStack matrices, int mouseX, int mouseY, float delta) {
         ...
         while(var7.hasNext()) {
            RecipeAlternativesWidget.AlternativeButtonWidget.InputSlot inputSlot = (RecipeAlternativesWidget.AlternativeButtonWidget.InputSlot)var7.next();
            RenderSystem.pushMatrix();
            float f = 0.42F;
