   ...
   public static BlockEntity createFromTag(BlockState state, CompoundTag tag) {
      ...
      return (BlockEntity)Registry.BLOCK_ENTITY_TYPE.getOrEmpty(new Identifier(string)).map((blockEntityType) -> {
         try {
            ...
            LOGGER.error((String)"Failed to create block entity {}", (Object)string, (Object)var3);
            return null;
         }
      }).map((blockEntity) -> {
         try {
            ...
            LOGGER.error((String)"Failed to load data for block entity {}", (Object)string, (Object)var5);
            return null;
         }
      }).orElseGet(() -> {
         LOGGER.warn((String)"Skipping BlockEntity with id {}", (Object)string);
         return null;
      });
   }
