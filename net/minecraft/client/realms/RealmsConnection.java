      ...
      (new Thread("Realms-connect-task") {
         public void run() {
            ...
            try {
               ...
               RealmsConnection.LOGGER.error((String)"Couldn't connect to world", (Throwable)var5);
               DisconnectedRealmsScreen disconnectedRealmsScreen = new DisconnectedRealmsScreen(RealmsConnection.this.onlineScreen, ScreenTexts.CONNECT_FAILED, new TranslatableText("disconnect.genericReason", new Object[]{"Unknown host '" + string + "'"}));
               ...
               RealmsConnection.LOGGER.error((String)"Couldn't connect to world", (Throwable)var6);
               ...
               DisconnectedRealmsScreen disconnectedRealmsScreen2 = new DisconnectedRealmsScreen(RealmsConnection.this.onlineScreen, ScreenTexts.CONNECT_FAILED, new TranslatableText("disconnect.genericReason", new Object[]{stringx}));
               minecraftClient.execute(() -> {
                  minecraftClient.openScreen(disconnectedRealmsScreen2);
               });
            }
