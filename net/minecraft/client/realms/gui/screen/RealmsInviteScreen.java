...
public class RealmsInviteScreen extends RealmsScreen {
   ...
   public void init() {
      ...
      this.field_22696 = new TextFieldWidget(this.client.textRenderer, this.width / 2 - 100, row(2), 200, 20, (TextFieldWidget)null, new TranslatableText("mco.configure.world.invite.profile.name"));
      this.addChild(this.field_22696);
      this.setInitialFocus(this.field_22696);
      this.addButton(new ButtonWidget(this.width / 2 - 100, row(10), 200, 20, new TranslatableText("mco.configure.world.buttons.invite"), (buttonWidget) -> {
         this.onInvite();
      }));
      this.addButton(new ButtonWidget(this.width / 2 - 100, row(12), 200, 20, ScreenTexts.CANCEL, (buttonWidget) -> {
