...
public class RandomPatchFeatureConfig implements FeatureConfig {
   public static final Codec<RandomPatchFeatureConfig> CODEC = RecordCodecBuilder.create((instance) -> {
      ...
      }), Codec.INT.fieldOf("tries").orElse(128).forGetter((randomPatchFeatureConfig) -> {
         return randomPatchFeatureConfig.tries;
      }), Codec.INT.fieldOf("xspread").orElse(7).forGetter((randomPatchFeatureConfig) -> {
         return randomPatchFeatureConfig.spreadX;
      }), Codec.INT.fieldOf("yspread").orElse(3).forGetter((randomPatchFeatureConfig) -> {
         return randomPatchFeatureConfig.spreadY;
      }), Codec.INT.fieldOf("zspread").orElse(7).forGetter((randomPatchFeatureConfig) -> {
