...
public class ChunkStatus {
   ...
   static {
      ...
      EMPTY = register("empty", (ChunkStatus)null, -1, PRE_CARVER_HEIGHTMAPS, ChunkStatus.ChunkType.field_12808, (ChunkStatus.SimpleGenerationTask)((world, generator, surroundingChunks, chunk) -> {
      }));
      STRUCTURE_STARTS = register("structure_starts", EMPTY, 0, PRE_CARVER_HEIGHTMAPS, ChunkStatus.ChunkType.field_12808, (ChunkStatus.GenerationTask)((targetStatus, world, generator, structureManager, lightingProvider, function, surroundingChunks, chunk) -> {
      ...
      STRUCTURE_REFERENCES = register("structure_references", STRUCTURE_STARTS, 8, PRE_CARVER_HEIGHTMAPS, ChunkStatus.ChunkType.field_12808, (ChunkStatus.SimpleGenerationTask)((world, generator, surroundingChunks, chunk) -> {
      ...
      BIOMES = register("biomes", STRUCTURE_REFERENCES, 0, PRE_CARVER_HEIGHTMAPS, ChunkStatus.ChunkType.field_12808, (ChunkStatus.SimpleGenerationTask)((world, generator, surroundingChunks, chunk) -> {
         generator.populateBiomes(world.getRegistryManager().get(Registry.BIOME_KEY), chunk);
      }));
      NOISE = register("noise", BIOMES, 8, PRE_CARVER_HEIGHTMAPS, ChunkStatus.ChunkType.field_12808, (ChunkStatus.SimpleGenerationTask)((world, generator, surroundingChunks, chunk) -> {
         ChunkRegion chunkRegion = new ChunkRegion(world, surroundingChunks);
         generator.populateNoise(chunkRegion, world.getStructureAccessor().forRegion(chunkRegion), chunk);
      }));
      SURFACE = register("surface", NOISE, 0, PRE_CARVER_HEIGHTMAPS, ChunkStatus.ChunkType.field_12808, (ChunkStatus.SimpleGenerationTask)((world, generator, surroundingChunks, chunk) -> {
         generator.buildSurface(new ChunkRegion(world, surroundingChunks), chunk);
      }));
      CARVERS = register("carvers", SURFACE, 0, PRE_CARVER_HEIGHTMAPS, ChunkStatus.ChunkType.field_12808, (ChunkStatus.SimpleGenerationTask)((world, generator, surroundingChunks, chunk) -> {
         generator.carve(world.getSeed(), world.getBiomeAccess(), chunk, GenerationStep.Carver.AIR);
      }));
      LIQUID_CARVERS = register("liquid_carvers", CARVERS, 0, POST_CARVER_HEIGHTMAPS, ChunkStatus.ChunkType.field_12808, (ChunkStatus.SimpleGenerationTask)((world, generator, surroundingChunks, chunk) -> {
         generator.carve(world.getSeed(), world.getBiomeAccess(), chunk, GenerationStep.Carver.LIQUID);
      }));
      FEATURES = register("features", LIQUID_CARVERS, 8, POST_CARVER_HEIGHTMAPS, ChunkStatus.ChunkType.field_12808, (ChunkStatus.GenerationTask)((status, world, generator, structureManager, lightingProvider, function, surroundingChunks, chunk) -> {
      ...
      LIGHT = register("light", FEATURES, 1, POST_CARVER_HEIGHTMAPS, ChunkStatus.ChunkType.field_12808, (targetStatus, world, generator, structureManager, lightingProvider, function, surroundingChunks, chunk) -> {
      ...
      SPAWN = register("spawn", LIGHT, 0, POST_CARVER_HEIGHTMAPS, ChunkStatus.ChunkType.field_12808, (ChunkStatus.SimpleGenerationTask)((targetStatus, generator, surroundingChunks, chunk) -> {
         generator.populateEntities(new ChunkRegion(targetStatus, surroundingChunks));
      }));
      HEIGHTMAPS = register("heightmaps", SPAWN, 0, POST_CARVER_HEIGHTMAPS, ChunkStatus.ChunkType.field_12808, (ChunkStatus.SimpleGenerationTask)((world, generator, surroundingChunks, chunk) -> {
      }));
      FULL = register("full", HEIGHTMAPS, 0, POST_CARVER_HEIGHTMAPS, ChunkStatus.ChunkType.field_12807, (targetStatus, world, generator, structureManager, lightingProvider, function, surroundingChunks, chunk) -> {
   ...
   interface SimpleGenerationTask extends ChunkStatus.GenerationTask {
      default CompletableFuture<Either<Chunk, ChunkHolder.Unloaded>> doWork(ChunkStatus chunkStatus, ServerWorld serverWorld, ChunkGenerator chunkGenerator, StructureManager structureManager, ServerLightingProvider serverLightingProvider, Function<Chunk, CompletableFuture<Either<Chunk, ChunkHolder.Unloaded>>> function, List<Chunk> list, Chunk chunk) {
   ...
   interface GenerationTask {
       ...
       */
      CompletableFuture<Either<Chunk, ChunkHolder.Unloaded>> doWork(ChunkStatus targetStatus, ServerWorld world, ChunkGenerator generator, StructureManager structureManager, ServerLightingProvider lightingProvider, Function<Chunk, CompletableFuture<Either<Chunk, ChunkHolder.Unloaded>>> function, List<Chunk> surroundingChunks, Chunk chunk);
   }
}
