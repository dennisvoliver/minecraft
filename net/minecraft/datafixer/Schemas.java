...
public class Schemas {
   ...
   private static void build(DataFixerBuilder builder) {
      ...
      builder.addFixer(BlockNameFix.create(schema53, "Flowing fixer", method_30070(ImmutableMap.of("minecraft:flowing_water", "minecraft:water", "minecraft:flowing_lava", "minecraft:lava"))));
      ...
      builder.addFixer(ItemNameFix.create(schema57, "Rename seagrass items", method_30070(ImmutableMap.of("minecraft:sea_grass", "minecraft:seagrass", "minecraft:tall_sea_grass", "minecraft:tall_seagrass"))));
      builder.addFixer(BlockNameFix.create(schema57, "Rename seagrass blocks", method_30070(ImmutableMap.of("minecraft:sea_grass", "minecraft:seagrass", "minecraft:tall_sea_grass", "minecraft:tall_seagrass"))));
      ...
      builder.addFixer(ItemNameFix.create(schema59, "Rename prismarine_brick(s)_* blocks", method_30070(ImmutableMap.of("minecraft:prismarine_bricks_slab", "minecraft:prismarine_brick_slab", "minecraft:prismarine_bricks_stairs", "minecraft:prismarine_brick_stairs"))));
      builder.addFixer(BlockNameFix.create(schema59, "Rename prismarine_brick(s)_* items", method_30070(ImmutableMap.of("minecraft:prismarine_bricks_slab", "minecraft:prismarine_brick_slab", "minecraft:prismarine_bricks_stairs", "minecraft:prismarine_brick_stairs"))));
      Schema schema60 = builder.addSchema(1488, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(BlockNameFix.create(schema60, "Rename kelp/kelptop", method_30070(ImmutableMap.of("minecraft:kelp_top", "minecraft:kelp", "minecraft:kelp", "minecraft:kelp_plant"))));
      ...
      builder.addFixer(ItemNameFix.create(schema61, "Rename melon_block/melon/speckled_melon", method_30070(ImmutableMap.of("minecraft:melon_block", "minecraft:melon", "minecraft:melon", "minecraft:melon_slice", "minecraft:speckled_melon", "minecraft:glistering_melon_slice"))));
      ...
      builder.addFixer(BlockNameFix.create(schema75, "Rename sign blocks & stone slabs", method_30070(ImmutableMap.of("minecraft:stone_slab", "minecraft:smooth_stone_slab", "minecraft:sign", "minecraft:oak_sign", "minecraft:wall_sign", "minecraft:oak_wall_sign"))));
      builder.addFixer(ItemNameFix.create(schema75, "Rename sign item & stone slabs", method_30070(ImmutableMap.of("minecraft:stone_slab", "minecraft:smooth_stone_slab", "minecraft:sign", "minecraft:oak_sign"))));
      ...
      builder.addFixer(new AdvancementRenameFix(schema96, false, "Rename sugar recipe advancement", method_30068("minecraft:recipes/misc/sugar", "minecraft:recipes/misc/sugar_from_sugar_cane")));
      ...
      builder.addFixer(new AdvancementRenameFix(schema103, false, "Composter category change", method_30068("minecraft:recipes/misc/composter", "minecraft:recipes/decorations/composter")));
      ...
      builder.addFixer(ItemNameFix.create(schema105, "Renamed fungi items to fungus", method_30070(ImmutableMap.of("minecraft:warped_fungi", "minecraft:warped_fungus", "minecraft:crimson_fungi", "minecraft:crimson_fungus"))));
      builder.addFixer(BlockNameFix.create(schema105, "Renamed fungi blocks to fungus", method_30070(ImmutableMap.of("minecraft:warped_fungi", "minecraft:warped_fungus", "minecraft:crimson_fungi", "minecraft:crimson_fungus"))));
      ...
      builder.addFixer(ItemNameFix.create(schema115, "Rename soul fire torch and soul fire lantern", method_30070(ImmutableMap.of("minecraft:soul_fire_torch", "minecraft:soul_torch", "minecraft:soul_fire_lantern", "minecraft:soul_lantern"))));
      builder.addFixer(BlockNameFix.create(schema115, "Rename soul fire torch and soul fire lantern", method_30070(ImmutableMap.of("minecraft:soul_fire_torch", "minecraft:soul_torch", "minecraft:soul_fire_wall_torch", "minecraft:soul_wall_torch", "minecraft:soul_fire_lantern", "minecraft:soul_lantern"))));
