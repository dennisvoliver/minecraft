...
public class UnderwaterDiskFeature extends DiskFeature {
   ...
   public boolean generate(StructureWorldAccess structureWorldAccess, ChunkGenerator chunkGenerator, Random random, BlockPos blockPos, DiskFeatureConfig diskFeatureConfig) {
      return !structureWorldAccess.getFluidState(blockPos).isIn(FluidTags.WATER) ? false : super.generate(structureWorldAccess, chunkGenerator, random, blockPos, diskFeatureConfig);
   }
}
