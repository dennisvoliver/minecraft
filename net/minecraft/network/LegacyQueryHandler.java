   ...
   public void channelRead(ChannelHandlerContext channelHandlerContext, Object object) throws Exception {
      ...
      try {
         try {
            ...
            switch(i) {
            case 0:
               LOGGER.debug((String)"Ping: (<1.3.x) from {}:{}", (Object)inetSocketAddress.getAddress(), (Object)inetSocketAddress.getPort());
            ...
            case 1:
               ...
               LOGGER.debug((String)"Ping: (1.4-1.5.x) from {}:{}", (Object)inetSocketAddress.getAddress(), (Object)inetSocketAddress.getPort());
            ...
            default:
               ...
               LOGGER.debug((String)"Ping: (1.6) from {}:{}", (Object)inetSocketAddress.getAddress(), (Object)inetSocketAddress.getPort());
