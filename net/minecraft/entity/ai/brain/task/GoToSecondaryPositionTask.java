...
public class GoToSecondaryPositionTask extends Task<VillagerEntity> {
   ...
   protected boolean shouldRun(ServerWorld serverWorld, VillagerEntity villagerEntity) {
      ...
      if (optional.isPresent() && optional2.isPresent()) {
         ...
         if (!list.isEmpty()) {
            ...
            return this.chosenPosition != null && serverWorld.getRegistryKey() == this.chosenPosition.getDimension() && ((GlobalPos)optional2.get()).getPos().isWithinDistance(villagerEntity.getPos(), (double)this.primaryPositionActivationDistance);
         }
      }
   ...
   protected void run(ServerWorld serverWorld, VillagerEntity villagerEntity, long l) {
      if (l > this.nextRunTime && this.chosenPosition != null) {
         villagerEntity.getBrain().remember(MemoryModuleType.WALK_TARGET, (Object)(new WalkTarget(this.chosenPosition.getPos(), this.speed, this.completionRange)));
