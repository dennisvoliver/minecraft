...
public class ZombieEntity extends HostileEntity {
   ...
   protected void convertTo(EntityType<? extends ZombieEntity> entityType) {
      ZombieEntity zombieEntity = (ZombieEntity)this.method_29243(entityType, true);
   ...
   public EntityData initialize(ServerWorldAccess world, LocalDifficulty difficulty, SpawnReason spawnReason, @Nullable EntityData entityData, @Nullable CompoundTag entityTag) {
      EntityData entityData = super.initialize(world, difficulty, spawnReason, entityData, entityTag);
         ...
         if (zombieData.baby) {
            ...
            if (zombieData.field_25607) {
               if ((double)world.getRandom().nextFloat() < 0.05D) {
                  ...
                  chickenEntity2.initialize(world, difficulty, SpawnReason.JOCKEY, (EntityData)null, (CompoundTag)null);
