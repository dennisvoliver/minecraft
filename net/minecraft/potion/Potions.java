...
public class Potions {
   public static final Potion EMPTY = register("empty", new Potion(new StatusEffectInstance[0]));
   public static final Potion WATER = register("water", new Potion(new StatusEffectInstance[0]));
   public static final Potion MUNDANE = register("mundane", new Potion(new StatusEffectInstance[0]));
   public static final Potion THICK = register("thick", new Potion(new StatusEffectInstance[0]));
   public static final Potion AWKWARD = register("awkward", new Potion(new StatusEffectInstance[0]));
