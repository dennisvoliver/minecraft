...
public class BlockAgeStructureProcessor extends StructureProcessor {
   public static final Codec<BlockAgeStructureProcessor> CODEC;
   ...
   static {
      CODEC = Codec.FLOAT.fieldOf("mossiness").xmap(BlockAgeStructureProcessor::new, (blockAgeStructureProcessor) -> {
         return blockAgeStructureProcessor.mossiness;
      }).codec();
   }
}
