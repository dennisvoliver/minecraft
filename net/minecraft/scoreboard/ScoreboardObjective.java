...
public class ScoreboardObjective {
   ...
   private Text method_27441() {
      return Texts.bracketed(this.displayName.shallowCopy().styled((style) -> {
         return style.withHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, new LiteralText(this.name)));
      }));
   }
