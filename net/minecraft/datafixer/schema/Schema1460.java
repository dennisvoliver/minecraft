...
public class Schema1460 extends IdentifierNormalizingSchema {
   ...
   public Map<String, Supplier<TypeTemplate>> registerEntities(Schema schema) {
      ...
      schema.register(map, "minecraft:arrow", (Function)((string) -> {
      ...
      schema.register(map, "minecraft:chest_minecart", (Function)((string) -> {
      ...
      schema.register(map, "minecraft:commandblock_minecart", (Function)((string) -> {
      ...
      schema.register(map, "minecraft:donkey", (Function)((string) -> {
      ...
      schema.register(map, "minecraft:enderman", (Function)((string) -> {
      ...
      schema.register(map, "minecraft:falling_block", (Function)((string) -> {
      ...
      schema.register(map, "minecraft:fireworks_rocket", (Function)((string) -> {
         return DSL.optionalFields("FireworksItem", TypeReferences.ITEM_STACK.in(schema));
      }));
      schema.register(map, "minecraft:furnace_minecart", (Function)((string) -> {
         return DSL.optionalFields("DisplayState", TypeReferences.BLOCK_STATE.in(schema));
      }));
      method_5232(schema, map, "minecraft:ghast");
      method_5232(schema, map, "minecraft:giant");
      method_5232(schema, map, "minecraft:guardian");
      schema.register(map, "minecraft:hopper_minecart", (Function)((string) -> {
         return DSL.optionalFields("DisplayState", TypeReferences.BLOCK_STATE.in(schema), "Items", DSL.list(TypeReferences.ITEM_STACK.in(schema)));
      }));
      schema.register(map, "minecraft:horse", (Function)((string) -> {
      ...
      schema.register(map, "minecraft:item", (Function)((string) -> {
         return DSL.optionalFields("Item", TypeReferences.ITEM_STACK.in(schema));
      }));
      schema.register(map, "minecraft:item_frame", (Function)((string) -> {
         return DSL.optionalFields("Item", TypeReferences.ITEM_STACK.in(schema));
      }));
      schema.registerSimple(map, "minecraft:leash_knot");
      schema.register(map, "minecraft:llama", (Function)((string) -> {
      ...
      schema.register(map, "minecraft:minecart", (Function)((string) -> {
         return DSL.optionalFields("DisplayState", TypeReferences.BLOCK_STATE.in(schema));
      }));
      method_5232(schema, map, "minecraft:mooshroom");
      schema.register(map, "minecraft:mule", (Function)((string) -> {
         return DSL.optionalFields("Items", DSL.list(TypeReferences.ITEM_STACK.in(schema)), "SaddleItem", TypeReferences.ITEM_STACK.in(schema), Schema100.targetItems(schema));
      }));
      ...
      schema.register(map, "minecraft:potion", (Function)((string) -> {
      ...
      schema.register(map, "minecraft:skeleton_horse", (Function)((string) -> {
      ...
      schema.register(map, "minecraft:spawner_minecart", (Function)((string) -> {
         return DSL.optionalFields("DisplayState", TypeReferences.BLOCK_STATE.in(schema), TypeReferences.UNTAGGED_SPAWNER.in(schema));
      }));
      schema.register(map, "minecraft:spectral_arrow", (Function)((string) -> {
         return DSL.optionalFields("inBlockState", TypeReferences.BLOCK_STATE.in(schema));
      }));
      ...
      schema.register(map, "minecraft:tnt_minecart", (Function)((string) -> {
         return DSL.optionalFields("DisplayState", TypeReferences.BLOCK_STATE.in(schema));
      }));
      method_5232(schema, map, "minecraft:vex");
      schema.register(map, "minecraft:villager", (Function)((string) -> {
      ...
      schema.register(map, "minecraft:zombie_horse", (Function)((string) -> {
         return DSL.optionalFields("SaddleItem", TypeReferences.ITEM_STACK.in(schema), Schema100.targetItems(schema));
      }));
   ...
   public Map<String, Supplier<TypeTemplate>> registerBlockEntities(Schema schema) {
      ...
      schema.register(map, "minecraft:jukebox", (Function)((string) -> {
      ...
      schema.register(map, "minecraft:mob_spawner", (Function)((string) -> {
         return TypeReferences.UNTAGGED_SPAWNER.in(schema);
      }));
      schema.register(map, "minecraft:piston", (Function)((string) -> {
