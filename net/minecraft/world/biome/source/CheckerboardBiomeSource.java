...
public class CheckerboardBiomeSource extends BiomeSource {
   public static final Codec<CheckerboardBiomeSource> CODEC = RecordCodecBuilder.create((instance) -> {
      return instance.group(Biome.field_26750.fieldOf("biomes").forGetter((checkerboardBiomeSource) -> {
         return checkerboardBiomeSource.biomeArray;
      }), Codec.intRange(0, 62).fieldOf("scale").orElse(2).forGetter((checkerboardBiomeSource) -> {
         return checkerboardBiomeSource.scale;
      })).apply(instance, (BiFunction)(CheckerboardBiomeSource::new));
   });
