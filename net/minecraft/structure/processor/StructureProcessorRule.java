...
public class StructureProcessorRule {
   public static final Codec<StructureProcessorRule> CODEC = RecordCodecBuilder.create((instance) -> {
      ...
      }), CompoundTag.CODEC.optionalFieldOf("output_nbt").forGetter((structureProcessorRule) -> {
         return Optional.ofNullable(structureProcessorRule.tag);
   ...
   public StructureProcessorRule(RuleTest ruleTest, RuleTest ruleTest2, PosRuleTest posRuleTest, BlockState blockState, Optional<CompoundTag> optional) {
      ...
      this.tag = (CompoundTag)optional.orElse((Object)null);
   }
