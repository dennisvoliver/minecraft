...
public class TextSearchableContainer<T> extends IdentifierSearchableContainer<T> {
   ...
   public List<T> findAll(String text) {
      ...
      if (i < 0) {
         ...
         return Lists.newArrayList((java.util.Iterator)(new IdentifierSearchableContainer.Iterator(list.iterator(), new TextSearchableContainer.Iterator(list2.iterator(), list3.iterator(), this::compare), this::compare)));
      }
   }
