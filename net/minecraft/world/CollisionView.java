...
public interface CollisionView extends BlockView {
   ...
   default boolean isSpaceEmpty(Box box) {
      return this.isSpaceEmpty((Entity)null, box, (entity) -> {
         return true;
      });
   }

   default boolean isSpaceEmpty(Entity entity) {
      return this.isSpaceEmpty(entity, entity.getBoundingBox(), (entityx) -> {
         return true;
      });
   }

   default boolean isSpaceEmpty(Entity entity, Box box) {
      return this.isSpaceEmpty(entity, box, (entityx) -> {
         return true;
      });
   }
