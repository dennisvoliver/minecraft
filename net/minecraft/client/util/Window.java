...
public final class Window implements AutoCloseable {
   ...
   public Window(WindowEventHandler eventHandler, MonitorTracker monitorTracker, WindowSettings settings, @Nullable String videoMode, String title) {
      ...
      this.handle = GLFW.glfwCreateWindow(this.width, this.height, (CharSequence)title, this.fullscreen && monitor != null ? monitor.getHandle() : 0L, 0L);
      if (monitor != null) {
   ...
   public void setIcon(InputStream icon16, InputStream icon32) {
      ...
      try {
         ...
         LOGGER.error((String)"Couldn't set icon", (Throwable)var21);
      }
   ...
   private ByteBuffer readImage(InputStream in, IntBuffer x, IntBuffer y, IntBuffer channels) throws IOException {
      ...
      try {
         ...
         byteBuffer.rewind();
         var6 = STBImage.stbi_load_from_memory(byteBuffer, (IntBuffer)x, (IntBuffer)y, (IntBuffer)channels, 0);
      } finally {
         if (byteBuffer != null) {
            MemoryUtil.memFree((java.nio.Buffer)byteBuffer);
         }
   ...
   public void logGlError(int error, long description) {
      ...
      LOGGER.error((String)"@ {}", (Object)this.phase);
      LOGGER.error((String)"{}: {}", (Object)error, (Object)string);
   }
   ...
   private void updateFullscreen(boolean vsync) {
      ...
      try {
         ...
         LOGGER.error((String)"Couldn't toggle fullscreen", (Throwable)var3);
      }
   ...
   public void setTitle(String title) {
      GLFW.glfwSetWindowTitle(this.handle, (CharSequence)title);
   }
