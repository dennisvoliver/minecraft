...
public class VanillaLayeredBiomeSource extends BiomeSource {
   public static final Codec<VanillaLayeredBiomeSource> CODEC = RecordCodecBuilder.create((instance) -> {
      ...
      })).apply(instance, (App)instance.stable(VanillaLayeredBiomeSource::new));
   });
