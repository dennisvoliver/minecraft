...
public class MissingDimensionFix extends DataFix {
   ...
   private static <A> Type<Pair<A, Dynamic<?>>> method_29913(String string, Type<A> type) {
      return DSL.and((Type)DSL.field(string, type), (Type)DSL.remainderType());
   }

   private static <A> Type<Pair<Either<A, Unit>, Dynamic<?>>> method_29915(String string, Type<A> type) {
      return DSL.and(DSL.optional((Type)DSL.field(string, type)), DSL.remainderType());
   }
   ...
   private static <A1, A2> Type<Pair<Either<A1, Unit>, Pair<Either<A2, Unit>, Dynamic<?>>>> method_29914(String string, Type<A1> type, String string2, Type<A2> type2) {
      return DSL.and(DSL.optional((Type)DSL.field(string, type)), DSL.optional((Type)DSL.field(string2, type2)), DSL.remainderType());
   }

   protected TypeRewriteRule makeRule() {
      Schema schema = this.getInputSchema();
      TaggedChoiceType<String> taggedChoiceType = new TaggedChoiceType("type", DSL.string(), ImmutableMap.of("minecraft:debug", DSL.remainderType(), "minecraft:flat", method_29915("settings", method_29914("biome", schema.getType(TypeReferences.BIOME), "layers", DSL.list(method_29915("block", schema.getType(TypeReferences.BLOCK_NAME))))), "minecraft:noise", method_29914("biome_source", DSL.taggedChoiceType("type", DSL.string(), ImmutableMap.of("minecraft:fixed", method_29913("biome", schema.getType(TypeReferences.BIOME)), "minecraft:multi_noise", DSL.list(method_29913("biome", schema.getType(TypeReferences.BIOME))), "minecraft:checkerboard", method_29913("biomes", DSL.list(schema.getType(TypeReferences.BIOME))), "minecraft:vanilla_layered", DSL.remainderType(), "minecraft:the_end", DSL.remainderType())), "settings", DSL.or(DSL.string(), method_29914("default_block", schema.getType(TypeReferences.BLOCK_NAME), "default_fluid", schema.getType(TypeReferences.BLOCK_NAME))))));
