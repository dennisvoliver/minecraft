...
public class RealmsWorldSlotButton extends ButtonWidget implements TickableElement {
   ...
   private void drawSlotFrame(MatrixStack matrices, int x, int y, int mouseX, int mouseY, boolean bl, String text, int i, long l, @Nullable String string, boolean bl2, boolean bl3, RealmsWorldSlotButton.Action action, @Nullable Text text2) {
