...
public class ClientChunkManager extends ChunkManager {
   ...
   public WorldChunk loadChunkFromPacket(int x, int z, @Nullable BiomeArray biomes, PacketByteBuf buf, CompoundTag tag, int verticalStripBitmask, boolean complete) {
      if (!this.chunks.isInRadius(x, z)) {
         LOGGER.warn((String)"Ignoring chunk since it's not in the view range: {}, {}", (Object)x, (Object)z);
         return null;
      } else {
         ...
         if (!complete && positionEquals(worldChunk, x, z)) {
            ...
            if (biomes == null) {
               LOGGER.warn((String)"Ignoring chunk since we don't have complete data: {}, {}", (Object)x, (Object)z);
               return null;
            }
