   ...
   public static class Piece extends SimpleStructurePiece {
      ...
      protected void handleMetadata(String metadata, BlockPos pos, ServerWorldAccess serverWorldAccess, Random random, BlockBox boundingBox) {
         if ("chest".equals(metadata)) {
            ...
            DrownedEntity drownedEntity = (DrownedEntity)EntityType.DROWNED.create(serverWorldAccess.toServerWorld());
            drownedEntity.setPersistent();
            drownedEntity.refreshPositionAndAngles(pos, 0.0F, 0.0F);
            drownedEntity.initialize(serverWorldAccess, serverWorldAccess.getLocalDifficulty(pos), SpawnReason.STRUCTURE, (EntityData)null, (CompoundTag)null);
