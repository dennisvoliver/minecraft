...
public class ClientPlayerEntity extends AbstractClientPlayerEntity {
   ...
   private boolean wouldCollideAt(BlockPos blockPos) {
      ...
      Box box2 = (new Box((double)blockPos.getX(), box.minY, (double)blockPos.getZ(), (double)blockPos.getX() + 1.0D, box.maxY, (double)blockPos.getZ() + 1.0D)).contract(1.0E-7D);
      return !this.world.isBlockSpaceEmpty(this, box2, (blockState, blockPosx) -> {
         return blockState.shouldSuffocate(this.world, blockPosx);
      });
   }
