         ...
         for(int k = -i; k <= i; ++k) {
            ...
            if (!bl5 || !bl6) {
               ...
               if (!world.getBlockState(mutable).isOpaqueFullCube(world, mutable)) {
                  ...
                  this.setBlockState(world, mutable, (BlockState)((BlockState)((BlockState)((BlockState)config.capProvider.getBlockState(random, start).with(MushroomBlock.WEST, bl7)).with(MushroomBlock.EAST, bl8)).with(MushroomBlock.NORTH, bl9)).with(MushroomBlock.SOUTH, bl10));
               }
            }
         }
      }
