...
public class RealmsUploadScreen extends RealmsScreen {
   ...
   public void init() {
      ...
      this.backButton = (ButtonWidget)this.addButton(new ButtonWidget(this.width / 2 - 100, this.height - 42, 200, 20, ScreenTexts.BACK, (buttonWidget) -> {
         this.onBack();
      }));
      this.backButton.visible = false;
      this.cancelButton = (ButtonWidget)this.addButton(new ButtonWidget(this.width / 2 - 100, this.height - 42, 200, 20, ScreenTexts.CANCEL, (buttonWidget) -> {
         this.onCancel();
      }));
   ...
   private void drawProgressBar(MatrixStack matrixStack) {
      double d = Math.min((double)this.uploadStatus.bytesWritten / (double)this.uploadStatus.totalBytes, 1.0D);
   ...
   private void upload() {
      ...
      (new Thread(() -> {
         ...
         try {
            ...
            if (uploadInfo != null) {
               ...
               if (!this.verify(file)) {
                  ...
                  if (!SizeUnit.humanReadableSize(m, sizeUnit).equals(SizeUnit.humanReadableSize(5368709120L, sizeUnit2)) || sizeUnit == SizeUnit.B) {
                     this.method_27460(new TranslatableText("mco.upload.size.failure.line1", new Object[]{this.selectedLevel.getDisplayName()}), new TranslatableText("mco.upload.size.failure.line2", new Object[]{SizeUnit.humanReadableSize(m, sizeUnit), SizeUnit.humanReadableSize(5368709120L, sizeUnit2)}));
                     return;
                  }

                  SizeUnit sizeUnit3 = SizeUnit.values()[sizeUnit.ordinal() - 1];
                  this.method_27460(new TranslatableText("mco.upload.size.failure.line1", new Object[]{this.selectedLevel.getDisplayName()}), new TranslatableText("mco.upload.size.failure.line2", new Object[]{SizeUnit.humanReadableSize(m, sizeUnit3), SizeUnit.humanReadableSize(5368709120L, sizeUnit3)}));
                  return;
               }

               this.status = new TranslatableText("mco.upload.uploading", new Object[]{this.selectedLevel.getDisplayName()});
               ...
               fileUpload.upload((uploadResult) -> {
                  if (uploadResult.statusCode >= 200 && uploadResult.statusCode < 300) {
                     ...
                     this.method_27460(new TranslatableText("mco.upload.failed", new Object[]{uploadResult.errorMessage}));
                  } else {
                     this.method_27460(new TranslatableText("mco.upload.failed", new Object[]{uploadResult.statusCode}));
                  }
            ...
            this.method_27460(new TranslatableText("mco.upload.failed", new Object[]{var21.getMessage()}));
            return;
         } catch (RealmsServiceException var22) {
            this.method_27460(new TranslatableText("mco.upload.failed", new Object[]{var22.toString()}));
            return;
