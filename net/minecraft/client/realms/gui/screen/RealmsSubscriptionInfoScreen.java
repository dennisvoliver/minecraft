...
public class RealmsSubscriptionInfoScreen extends RealmsScreen {
   ...
   public void init() {
      ...
      this.addButton(new ButtonWidget(this.width / 2 - 100, row(6), 200, 20, new TranslatableText("mco.configure.world.subscription.extend"), (buttonWidget) -> {
         ...
         (new Thread("Realms-delete-realm") {
            public void run() {
               ...
               RealmsSubscriptionInfoScreen.this.client.execute(() -> {
                  RealmsSubscriptionInfoScreen.this.client.openScreen(RealmsSubscriptionInfoScreen.this.mainScreen);
               });
            }
         }).start();
      }
