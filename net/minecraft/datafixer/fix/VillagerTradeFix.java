...
public class VillagerTradeFix extends ChoiceFix {
   ...
   protected Typed<?> transform(Typed<?> inputType) {
      ...
      if (!(type instanceof ListType)) {
         ...
         OpticFinder<Pair<String, String>> opticFinder7 = DSL.fieldFinder("id", DSL.named(TypeReferences.ITEM_NAME.typeName(), IdentifierNormalizingSchema.getIdentifierType()));
