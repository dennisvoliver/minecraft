...
public class BubbleColumnSoundPlayer implements ClientPlayerTickable {
   ...
   public void tick() {
      ...
      BlockState blockState = (BlockState)world.method_29556(this.player.getBoundingBox().expand(0.0D, -0.4000000059604645D, 0.0D).contract(0.001D)).filter((blockStatex) -> {
