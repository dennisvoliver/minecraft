...
public class RealmsCreateRealmScreen extends RealmsScreen {
   ...
   public void init() {
      ...
      this.createButton = (ButtonWidget)this.addButton(new ButtonWidget(this.width / 2 - 100, this.height / 4 + 120 + 17, 97, 20, new TranslatableText("mco.create.world"), (buttonWidget) -> {
         this.createWorld();
      }));
      this.addButton(new ButtonWidget(this.width / 2 + 5, this.height / 4 + 120 + 17, 95, 20, ScreenTexts.CANCEL, (buttonWidget) -> {
         this.client.openScreen(this.parent);
      }));
      this.createButton.active = false;
      this.nameBox = new TextFieldWidget(this.client.textRenderer, this.width / 2 - 100, 65, 200, 20, (TextFieldWidget)null, new TranslatableText("mco.configure.world.name"));
      this.addChild(this.nameBox);
      this.setInitialFocus(this.nameBox);
      this.descriptionBox = new TextFieldWidget(this.client.textRenderer, this.width / 2 - 100, 115, 200, 20, (TextFieldWidget)null, new TranslatableText("mco.configure.world.description"));
   ...
   private void createWorld() {
      if (this.valid()) {
         RealmsResetWorldScreen realmsResetWorldScreen = new RealmsResetWorldScreen(this.parent, this.server, new TranslatableText("mco.selectServer.create"), new TranslatableText("mco.create.world.subtitle"), 10526880, new TranslatableText("mco.create.world.skip"), () -> {
