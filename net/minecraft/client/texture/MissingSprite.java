...
public final class MissingSprite extends Sprite {
   ...
   private MissingSprite(SpriteAtlasTexture spriteAtlasTexture, int maxLevel, int atlasWidth, int atlasHeight, int x, int y) {
      super(spriteAtlasTexture, INFO, maxLevel, atlasWidth, atlasHeight, x, y, (NativeImage)IMAGE.get());
   }
   ...
   static {
      INFO = new Sprite.Info(MISSINGNO, 16, 16, new AnimationResourceMetadata(Lists.newArrayList((Object[])(new AnimationFrameResourceMetadata(0, -1))), 16, 16, 1, false));
   }
}
