...
public class FurnaceRecipesFix extends DataFix {
   ...
   private <R> TypeRewriteRule updateBlockEntities(Type<R> type) {
      Type<Pair<Either<Pair<List<Pair<R, Integer>>, Dynamic<?>>, Unit>, Dynamic<?>>> type2 = DSL.and(DSL.optional((Type)DSL.field("RecipesUsed", DSL.and((Type)DSL.compoundList(type, DSL.intType()), (Type)DSL.remainderType()))), DSL.remainderType());
