      ...
      if (direction == Direction.DOWN) {
         ...
         if (world.isSpaceEmpty((Entity)null, box, (entity) -> {
            ...
            if (world instanceof ServerWorld) {
               ...
               ArmorStandEntity armorStandEntity = (ArmorStandEntity)EntityType.ARMOR_STAND.create(serverWorld, itemStack.getTag(), (Text)null, context.getPlayer(), blockPos, SpawnReason.SPAWN_EGG, true, true);
