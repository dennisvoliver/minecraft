...
public class GlDebug {
   ...
   private static void info(int source, int type, int id, int severity, int i, long l, long m) {
      LOGGER.info((String)"OpenGL debug message, id={}, source={}, type={}, severity={}, message={}", (Object)id, getSource(source), getType(type), getSeverity(severity), GLDebugMessageCallback.getMessage(i, l));
   }
