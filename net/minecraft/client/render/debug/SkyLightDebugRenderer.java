...
public class SkyLightDebugRenderer implements DebugRenderer.Renderer {
   ...
   public void render(MatrixStack matrices, VertexConsumerProvider vertexConsumers, double cameraX, double cameraY, double cameraZ) {
      ...
      while(var12.hasNext()) {
         ...
         if (longSet.add(l)) {
            DebugRenderer.drawString(world.getChunkManager().getLightingProvider().displaySectionLevel(LightType.SKY, ChunkSectionPos.from(l)), (double)(ChunkSectionPos.unpackX(l) * 16 + 8), (double)(ChunkSectionPos.unpackY(l) * 16 + 8), (double)(ChunkSectionPos.unpackZ(l) * 16 + 8), 16711680, 0.3F);
         }
