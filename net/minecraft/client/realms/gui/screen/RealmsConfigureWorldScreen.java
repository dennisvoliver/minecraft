...
public class RealmsConfigureWorldScreen extends RealmsScreenWithCallback {
   ...
   public void init() {
      ...
      this.playersButton = (ButtonWidget)this.addButton(new ButtonWidget(this.buttonCenter(0, 3), row(0), 100, 20, new TranslatableText("mco.configure.world.buttons.players"), (buttonWidget) -> {
         this.client.openScreen(new RealmsPlayerScreen(this, this.server));
      }));
      this.settingsButton = (ButtonWidget)this.addButton(new ButtonWidget(this.buttonCenter(1, 3), row(0), 100, 20, new TranslatableText("mco.configure.world.buttons.settings"), (buttonWidget) -> {
         this.client.openScreen(new RealmsSettingsScreen(this, this.server.clone()));
      }));
      this.subscriptionButton = (ButtonWidget)this.addButton(new ButtonWidget(this.buttonCenter(2, 3), row(0), 100, 20, new TranslatableText("mco.configure.world.buttons.subscription"), (buttonWidget) -> {
      ...
      this.switchMinigameButton = (ButtonWidget)this.addButton(new ButtonWidget(this.buttonLeft(0), row(13) - 5, 100, 20, new TranslatableText("mco.configure.world.buttons.switchminigame"), (buttonWidget) -> {
      ...
      this.optionsButton = (ButtonWidget)this.addButton(new ButtonWidget(this.buttonLeft(0), row(13) - 5, 90, 20, new TranslatableText("mco.configure.world.buttons.options"), (buttonWidget) -> {
      ...
      this.backupButton = (ButtonWidget)this.addButton(new ButtonWidget(this.buttonLeft(1), row(13) - 5, 90, 20, new TranslatableText("mco.configure.world.backup"), (buttonWidget) -> {
         this.client.openScreen(new RealmsBackupScreen(this, this.server.clone(), this.server.activeSlot));
      }));
      this.resetWorldButton = (ButtonWidget)this.addButton(new ButtonWidget(this.buttonLeft(2), row(13) - 5, 90, 20, new TranslatableText("mco.configure.world.buttons.resetworld"), (buttonWidget) -> {
   ...
   public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
      ...
      if (this.server == null) {
         ...
         int k = this.textRenderer.getWidth((StringVisitable)field_26480);
         ...
         if (this.isMinigame()) {
            this.textRenderer.draw(matrices, (Text)field_26481.shallowCopy().append(this.server.getMinigameName()), (float)(this.left_x + 80 + 20 + 10), (float)row(13), 16777215);
         }
