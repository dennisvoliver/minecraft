...
public class PacifyTask extends Task<LivingEntity> {
   ...
   public PacifyTask(MemoryModuleType<?> requiredMemoryModuleType, int duration) {
      super(ImmutableMap.of(MemoryModuleType.ATTACK_TARGET, MemoryModuleState.REGISTERED, MemoryModuleType.PACIFIED, MemoryModuleState.VALUE_ABSENT, requiredMemoryModuleType, MemoryModuleState.VALUE_PRESENT));
