...
public class ClientPlayerInteractionManager {
   ...
   private final Object2ObjectLinkedOpenHashMap<Pair<BlockPos, PlayerActionC2SPacket.Action>, Vec3d> unacknowledgedPlayerActions;
   ...
   public ClientPlayerInteractionManager(MinecraftClient client, ClientPlayNetworkHandler networkHandler) {
      ...
      this.previousGameMode = GameMode.NOT_SET;
      ...
      if (this.blockBreakingCooldown > 0) {
         ...
         if (this.gameMode.isCreative() && this.client.world.getWorldBorder().contains(pos)) {
            ...
            if (blockState2.isAir()) {
               ...
               this.currentBreakingProgress += blockState2.calcBlockBreakingDelta(this.client.player, this.client.player.world, pos);
