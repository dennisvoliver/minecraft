...
public class GlUniform extends Uniform implements AutoCloseable {
   ...
   public void set(float[] values) {
      if (values.length < this.count) {
         LOGGER.warn((String)"Uniform.set called with a too-small value array (expected {}, got {}). Ignoring.", (Object)this.count, (Object)values.length);
      } else {
         this.floatData.position(0);
   ...
   public void upload() {
      ...
      if (this.dataType <= 3) {
         ...
         if (this.dataType > 10) {
            LOGGER.warn((String)"Uniform.upload called, but type value ({}) is not a valid type. Ignoring.", (Object)this.dataType);
            return;
         }
   ...
   private void uploadInts() {
      ...
      case 3:
         ...
         break;
      default:
         LOGGER.warn((String)"Uniform.upload called, but count value ({}) is  not in the range of 1 to 4. Ignoring.", (Object)this.count);
      }
