...
public class Schema704 extends Schema {
   protected static final Map<String, String> BLOCK_RENAMES = (Map)DataFixUtils.make(Maps.newHashMap(), (hashMap) -> {
   ...
   public Type<?> getChoiceType(TypeReference typeReference, String string) {
      return Objects.equals(typeReference.typeName(), TypeReferences.BLOCK_ENTITY.typeName()) ? super.getChoiceType(typeReference, IdentifierNormalizingSchema.normalize(string)) : super.getChoiceType(typeReference, string);
   }
   ...
   public Map<String, Supplier<TypeTemplate>> registerBlockEntities(Schema schema) {
      ...
      schema.register(map, "minecraft:flower_pot", (Function)((string) -> {
