...
public class FurnaceSmeltLootFunction extends ConditionalLootFunction {
   ...
   public ItemStack process(ItemStack stack, LootContext context) {
      if (stack.isEmpty()) {
         ...
         Optional<SmeltingRecipe> optional = context.getWorld().getRecipeManager().getFirstMatch(RecipeType.SMELTING, new SimpleInventory(new ItemStack[]{stack}), context.getWorld());
         ...
         LOGGER.warn((String)"Couldn't smelt {} because there is no smelting recipe", (Object)stack);
         return stack;
      }
   }
