...
public class OceanRuinFeature extends StructureFeature<OceanRuinFeatureConfig> {
   ...
   public static enum BiomeType implements StringIdentifiable {
      ...
      public static final Codec<OceanRuinFeature.BiomeType> CODEC = StringIdentifiable.createCodec(OceanRuinFeature.BiomeType::values, OceanRuinFeature.BiomeType::byName);
      private static final Map<String, OceanRuinFeature.BiomeType> BY_NAME = (Map)Arrays.stream(values()).collect(Collectors.toMap(OceanRuinFeature.BiomeType::getName, (biomeType) -> {
         return biomeType;
      }));
