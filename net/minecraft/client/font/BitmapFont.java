         ...
         try {
            ...
            try {
               ...
               for(int m = 0; m < this.chars.size(); ++m) {
                  int n = 0;
                  int[] var13 = (int[])this.chars.get(m);
                  ...
                  for(int var15 = 0; var15 < var14; ++var15) {
                     ...
                     if (o != 0 && o != 32) {
                        ...
                        BitmapFont.BitmapFontGlyph bitmapFontGlyph = (BitmapFont.BitmapFontGlyph)int2ObjectMap.put(o, new BitmapFont.BitmapFontGlyph(f, nativeImage, p * k, m * l, k, l, (int)(0.5D + (double)((float)q * f)) + 1, this.ascent));
                        if (bitmapFontGlyph != null) {
                           BitmapFont.LOGGER.warn((String)"Codepoint '{}' declared multiple times in {}", (Object)Integer.toHexString(o), (Object)this.filename);
                        }
                     }
                  }
               }

               BitmapFont var31 = new BitmapFont(nativeImage, int2ObjectMap);
               return var31;
