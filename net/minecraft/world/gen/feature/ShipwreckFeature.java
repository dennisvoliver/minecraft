...
public class ShipwreckFeature extends StructureFeature<ShipwreckFeatureConfig> {
   ...
   public static class Start extends StructureStart<ShipwreckFeatureConfig> {
      ...
      public void init(DynamicRegistryManager dynamicRegistryManager, ChunkGenerator chunkGenerator, StructureManager structureManager, int i, int j, Biome biome, ShipwreckFeatureConfig shipwreckFeatureConfig) {
