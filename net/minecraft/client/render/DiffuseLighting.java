...
public class DiffuseLighting {
   private static final Vector3f field_24426 = (Vector3f)Util.make(new Vector3f(0.2F, 1.0F, -0.7F), Vector3f::normalize);
   private static final Vector3f field_24427 = (Vector3f)Util.make(new Vector3f(-0.2F, 1.0F, 0.7F), Vector3f::normalize);
   private static final Vector3f field_24428 = (Vector3f)Util.make(new Vector3f(0.2F, 1.0F, -0.7F), Vector3f::normalize);
   private static final Vector3f field_24429 = (Vector3f)Util.make(new Vector3f(-0.2F, -1.0F, 0.7F), Vector3f::normalize);
