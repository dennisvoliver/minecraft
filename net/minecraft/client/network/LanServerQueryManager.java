      ...
      public void run() {
         ...
         while(!this.isInterrupted()) {
            ...
            try {
               ...
               LanServerQueryManager.LOGGER.error((String)"Couldn't ping server", (Throwable)var6);
               break;
            }

            String string = new String(datagramPacket.getData(), datagramPacket.getOffset(), datagramPacket.getLength(), StandardCharsets.UTF_8);
            LanServerQueryManager.LOGGER.debug((String)"{}: {}", (Object)datagramPacket.getAddress(), (Object)string);
