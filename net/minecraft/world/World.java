...
public abstract class World implements WorldAccess, AutoCloseable {
   ...
   static {
      CODEC = Identifier.CODEC.xmap(RegistryKey.createKeyFactory(Registry.DIMENSION), RegistryKey::getValue);
      OVERWORLD = RegistryKey.of(Registry.DIMENSION, new Identifier("overworld"));
      NETHER = RegistryKey.of(Registry.DIMENSION, new Identifier("the_nether"));
      END = RegistryKey.of(Registry.DIMENSION, new Identifier("the_end"));
