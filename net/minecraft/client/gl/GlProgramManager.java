...
public class GlProgramManager {
   ...
   public static void linkProgram(GlProgram glProgram) throws IOException {
      ...
      if (i == 0) {
         LOGGER.warn((String)"Error encountered when linking program containing VS {} and FS {}. Log output:", (Object)glProgram.getVertexShader().getName(), (Object)glProgram.getFragmentShader().getName());
