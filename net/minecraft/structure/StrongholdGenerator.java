...
public class StrongholdGenerator {
   ...
   public static class Library extends StrongholdGenerator.Piece {
      ...
      public boolean generate(StructureWorldAccess structureWorldAccess, StructureAccessor structureAccessor, ChunkGenerator chunkGenerator, Random random, BlockBox boundingBox, ChunkPos chunkPos, BlockPos blockPos) {
         ...
         if (this.tall) {
            ...
            for(int n = 0; n <= 2; ++n) {
               this.addBlock(structureWorldAccess, (BlockState)((BlockState)Blocks.OAK_FENCE.getDefaultState().with(FenceBlock.SOUTH, true)).with(FenceBlock.WEST, true), 8 + n, 6, 12 - n, boundingBox);
               if (n != 2) {
                  this.addBlock(structureWorldAccess, (BlockState)((BlockState)Blocks.OAK_FENCE.getDefaultState().with(FenceBlock.NORTH, true)).with(FenceBlock.EAST, true), 8 + n, 6, 11 - n, boundingBox);
               }
            }
   ...
   public static class SquareRoom extends StrongholdGenerator.Piece {
      ...
      public boolean generate(StructureWorldAccess structureWorldAccess, StructureAccessor structureAccessor, ChunkGenerator chunkGenerator, Random random, BlockBox boundingBox, ChunkPos chunkPos, BlockPos blockPos) {
         ...
         case 1:
            for(m = 0; m < 5; ++m) {
               this.addBlock(structureWorldAccess, Blocks.STONE_BRICKS.getDefaultState(), 3, 1, 3 + m, boundingBox);
               this.addBlock(structureWorldAccess, Blocks.STONE_BRICKS.getDefaultState(), 7, 1, 3 + m, boundingBox);
               this.addBlock(structureWorldAccess, Blocks.STONE_BRICKS.getDefaultState(), 3 + m, 1, 3, boundingBox);
               this.addBlock(structureWorldAccess, Blocks.STONE_BRICKS.getDefaultState(), 3 + m, 1, 7, boundingBox);
            }
         ...
         case 2:
            for(m = 1; m <= 9; ++m) {
               this.addBlock(structureWorldAccess, Blocks.COBBLESTONE.getDefaultState(), 1, 3, m, boundingBox);
               this.addBlock(structureWorldAccess, Blocks.COBBLESTONE.getDefaultState(), 9, 3, m, boundingBox);
            }

            for(m = 1; m <= 9; ++m) {
               this.addBlock(structureWorldAccess, Blocks.COBBLESTONE.getDefaultState(), m, 3, 1, boundingBox);
               this.addBlock(structureWorldAccess, Blocks.COBBLESTONE.getDefaultState(), m, 3, 9, boundingBox);
            }
            ...
            for(m = 1; m <= 3; ++m) {
               this.addBlock(structureWorldAccess, Blocks.COBBLESTONE.getDefaultState(), 4, m, 4, boundingBox);
               this.addBlock(structureWorldAccess, Blocks.COBBLESTONE.getDefaultState(), 6, m, 4, boundingBox);
               this.addBlock(structureWorldAccess, Blocks.COBBLESTONE.getDefaultState(), 4, m, 6, boundingBox);
               this.addBlock(structureWorldAccess, Blocks.COBBLESTONE.getDefaultState(), 6, m, 6, boundingBox);
            }
