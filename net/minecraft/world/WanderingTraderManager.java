...
public class WanderingTraderManager implements Spawner {
   ...
   private boolean method_18018(ServerWorld serverWorld) {
      ...
      if (playerEntity == null) {
         ...
         if (blockPos3 != null && this.doesNotSuffocateAt(serverWorld, blockPos3)) {
            ...
            WanderingTraderEntity wanderingTraderEntity = (WanderingTraderEntity)EntityType.WANDERING_TRADER.spawn(serverWorld, (CompoundTag)null, (Text)null, (PlayerEntity)null, blockPos3, SpawnReason.EVENT, false, false);
   ...
   private void spawnLlama(ServerWorld serverWorld, WanderingTraderEntity wanderingTraderEntity, int i) {
      ...
      if (blockPos != null) {
         TraderLlamaEntity traderLlamaEntity = (TraderLlamaEntity)EntityType.TRADER_LLAMA.spawn(serverWorld, (CompoundTag)null, (Text)null, (PlayerEntity)null, blockPos, SpawnReason.EVENT, false, false);
