...
public class GlStateManager {
   ...
   private static final GlStateManager.Texture2DState[] TEXTURES = (GlStateManager.Texture2DState[])IntStream.range(0, 12).mapToObj((i) -> {
   ...
   static class class_5518 {
      public final GlStateManager.CapabilityTracker field_26840;

      private class_5518() {
         this.field_26840 = new GlStateManager.CapabilityTracker(3089);
      }
   }
