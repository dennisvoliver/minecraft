...
public class Keyboard {
   ...
   private void debugWarn(String string, Object... objects) {
      this.client.inGameHud.getChatHud().addMessage((new LiteralText("")).append((new TranslatableText("debug.prefix")).formatted(new Formatting[]{Formatting.YELLOW, Formatting.BOLD})).append(" ").append((Text)(new TranslatableText(string, objects))));
   }

   private void debugError(String string, Object... objects) {
      this.client.inGameHud.getChatHud().addMessage((new LiteralText("")).append((new TranslatableText("debug.prefix")).formatted(new Formatting[]{Formatting.RED, Formatting.BOLD})).append(" ").append((Text)(new TranslatableText(string, objects))));
   }
