...
public class UploadInfo extends ValueObject {
   ...
   public static UploadInfo parse(String json) {
      try {
         ...
         String string = JsonUtils.getStringOr("uploadEndpoint", jsonObject, (String)null);
         if (string != null) {
            ...
            if (uRI != null) {
               ...
               String string2 = JsonUtils.getStringOr("token", jsonObject, (String)null);
   ...
   public static URI method_30862(String string, int i) {
      ...
      try {
         ...
         LOGGER.warn((String)"Failed to parse URI {}", (Object)string2, (Object)var6);
         return null;
      }
   }
