...
public class PiglinBruteBrain {
   ...
   protected static void method_30250(PiglinBruteEntity piglinBruteEntity) {
      ...
      piglinBruteEntity.getBrain().remember(MemoryModuleType.HOME, (Object)globalPos);
   }
   ...
   private static void method_30260(PiglinBruteEntity piglinBruteEntity, Brain<PiglinBruteEntity> brain) {
      brain.setTaskList(Activity.IDLE, 10, ImmutableList.of(new UpdateAttackTargetTask(PiglinBruteBrain::method_30247), method_30244(), method_30254(), new FindInteractionTargetTask(EntityType.PLAYER, 4)));
   }
   ...
   private static void method_30262(PiglinBruteEntity piglinBruteEntity, Brain<PiglinBruteEntity> brain) {
      brain.setTaskList(Activity.FIGHT, 10, ImmutableList.of(new ForgetAttackTargetTask((livingEntity) -> {
         return !method_30248(piglinBruteEntity, livingEntity);
   ...
   private static boolean method_30248(AbstractPiglinEntity abstractPiglinEntity, LivingEntity livingEntity) {
      return method_30247(abstractPiglinEntity).filter((livingEntity2) -> {
   ...
   protected static void method_30258(PiglinBruteEntity piglinBruteEntity) {
      if ((double)piglinBruteEntity.world.random.nextFloat() < 0.0125D) {
         method_30261(piglinBruteEntity);
      }
