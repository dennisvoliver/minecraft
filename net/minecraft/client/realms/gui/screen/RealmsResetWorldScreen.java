...
public class RealmsResetWorldScreen extends RealmsScreenWithCallback {
   ...
   public RealmsResetWorldScreen(Screen parent, RealmsServer realmsServer, Runnable runnable, Runnable runnable2) {
      this.title = new TranslatableText("mco.reset.world.title");
   ...
   public void init() {
      this.addButton(new ButtonWidget(this.width / 2 - 40, row(14) - 10, 80, 20, this.buttonTitle, (buttonWidget) -> {
      ...
      this.titleLabel = (RealmsLabel)this.addChild(new RealmsLabel(this.title, this.width / 2, 7, 16777215));
      this.subtitleLabel = (RealmsLabel)this.addChild(new RealmsLabel(this.subtitle, this.width / 2, 22, this.subtitleColor));
      this.addButton(new RealmsResetWorldScreen.FrameButton(this.frame(1), row(0) + 10, new TranslatableText("mco.reset.world.generate"), NEW_WORLD_TEXTURE, (buttonWidget) -> {
         this.client.openScreen(new RealmsResetNormalWorldScreen(this, this.title));
      }));
      this.addButton(new RealmsResetWorldScreen.FrameButton(this.frame(2), row(0) + 10, new TranslatableText("mco.reset.world.upload"), UPLOAD_TEXTURE, (buttonWidget) -> {
      ...
      this.addButton(new RealmsResetWorldScreen.FrameButton(this.frame(3), row(0) + 10, new TranslatableText("mco.reset.world.template"), SURVIVAL_SPAWN_TEXTURE, (buttonWidget) -> {
      ...
      this.addButton(new RealmsResetWorldScreen.FrameButton(this.frame(1), row(6) + 20, new TranslatableText("mco.reset.world.adventure"), ADVENTURE_TEXTURE, (buttonWidget) -> {
      ...
      this.addButton(new RealmsResetWorldScreen.FrameButton(this.frame(2), row(6) + 20, new TranslatableText("mco.reset.world.experience"), EXPERIENCE_TEXTURE, (buttonWidget) -> {
      ...
      this.addButton(new RealmsResetWorldScreen.FrameButton(this.frame(3), row(6) + 20, new TranslatableText("mco.reset.world.inspiration"), INSPIRATION_TEXTURE, (buttonWidget) -> {
   ...
   public void resetWorldWithTemplate(WorldTemplate template) {
      this.method_25207((String)null, template, -1, true);
   }

   private void triggerResetWorld(RealmsResetWorldScreen.ResetWorldInfo resetWorldInfo) {
      this.method_25207(resetWorldInfo.seed, (WorldTemplate)null, resetWorldInfo.levelType, resetWorldInfo.generateStructures);
   }
