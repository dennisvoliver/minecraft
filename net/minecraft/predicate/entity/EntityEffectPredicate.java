   ...
   public static EntityEffectPredicate fromJson(@Nullable JsonElement json) {
      if (json != null && !json.isJsonNull()) {
         ...
         while(var3.hasNext()) {
            ...
            EntityEffectPredicate.EffectData effectData = EntityEffectPredicate.EffectData.fromJson(JsonHelper.asObject((JsonElement)entry.getValue(), (String)entry.getKey()));
   ...
   public JsonElement toJson() {
      if (this == EMPTY) {
         ...
         while(var2.hasNext()) {
            ...
            jsonObject.add(Registry.STATUS_EFFECT.getId(entry.getKey()).toString(), ((EntityEffectPredicate.EffectData)entry.getValue()).toJson());
         }
