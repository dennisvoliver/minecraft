   ...
   protected void init() {
      ...
      if (this.initialized) {
         ...
         try {
            ...
            LOGGER.warn((String)"Unable to start LAN server detection: {}", (Object)var2.getMessage());
         }
      ...
      this.buttonEdit = (ButtonWidget)this.addButton(new ButtonWidget(this.width / 2 - 154, this.height - 28, 70, 20, new TranslatableText("selectServer.edit"), (buttonWidget) -> {
      ...
      this.buttonDelete = (ButtonWidget)this.addButton(new ButtonWidget(this.width / 2 - 74, this.height - 28, 70, 20, new TranslatableText("selectServer.delete"), (buttonWidget) -> {
         MultiplayerServerListWidget.Entry entry = (MultiplayerServerListWidget.Entry)this.serverListWidget.getSelected();
         if (entry instanceof MultiplayerServerListWidget.ServerEntry) {
      ...
      this.addButton(new ButtonWidget(this.width / 2 + 4, this.height - 28, 70, 20, new TranslatableText("selectServer.refresh"), (buttonWidget) -> {
         this.refresh();
      }));
