...
public class Model {
   ...
   private Map<TextureKey, Identifier> createTextureMap(Texture texture) {
      Stream var10000 = Streams.concat(this.requiredTextures.stream(), texture.getInherited());
      Function var10001 = Function.identity();
      texture.getClass();
      return (Map)var10000.collect(ImmutableMap.toImmutableMap(var10001, texture::getTexture));
   }
}
