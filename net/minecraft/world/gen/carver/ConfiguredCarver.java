...
public class ConfiguredCarver<WC extends CarverConfig> {
   public static final Codec<ConfiguredCarver<?>> CODEC;
   public static final Codec<Supplier<ConfiguredCarver<?>>> REGISTRY_CODEC;
   public static final Codec<List<Supplier<ConfiguredCarver<?>>>> field_26755;
   ...
   static {
      CODEC = Registry.CARVER.dispatch((configuredCarver) -> {
         return configuredCarver.carver;
      }, Carver::getCodec);
      REGISTRY_CODEC = RegistryElementCodec.of(Registry.CONFIGURED_CARVER_WORLDGEN, CODEC);
      field_26755 = RegistryElementCodec.method_31194(Registry.CONFIGURED_CARVER_WORLDGEN, CODEC);
   }
}
