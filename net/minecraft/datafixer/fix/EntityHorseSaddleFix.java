...
public class EntityHorseSaddleFix extends ChoiceFix {
   ...
   protected Typed<?> transform(Typed<?> inputType) {
      ...
      if (!optional.isPresent() && dynamic.get("Saddle").asBoolean(false)) {
         ...
         typed = typed.set(opticFinder, (Object)Pair.of(TypeReferences.ITEM_NAME.typeName(), "minecraft:saddle"));
         ...
         return inputType.set(opticFinder2, typed).set(DSL.remainderFinder(), (Object)dynamic);
      } else {
         return inputType;
      }
   }
