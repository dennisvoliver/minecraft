         ...
         if (optional.isPresent() && Objects.equals(((Pair)optional.get()).getSecond(), "minecraft:potion")) {
            ...
            if (optional2.isPresent()) {
               ...
               if (!optional3.isPresent()) {
                  ...
                  Typed<?> typed3 = ((Typed)optional2.get()).set(DSL.remainderFinder(), (Object)dynamic2.set("Potion", dynamic2.createString(string == null ? "minecraft:water" : string)));
                  typed2 = typed.set(opticFinder2, typed3);
                  if ((s & 16384) == 16384) {
                     typed2 = typed2.set(opticFinder, (Object)Pair.of(TypeReferences.ITEM_NAME.typeName(), "minecraft:splash_potion"));
                  }
               }
