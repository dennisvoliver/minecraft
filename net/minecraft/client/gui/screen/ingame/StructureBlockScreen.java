...
public class StructureBlockScreen extends Screen {
   ...
   protected void init() {
      ...
      this.buttonDone = (ButtonWidget)this.addButton(new ButtonWidget(this.width / 2 - 4 - 150, 210, 150, 20, ScreenTexts.DONE, (buttonWidget) -> {
         this.done();
      }));
      this.buttonCancel = (ButtonWidget)this.addButton(new ButtonWidget(this.width / 2 + 4, 210, 150, 20, ScreenTexts.CANCEL, (buttonWidget) -> {
         this.cancel();
      }));
      this.buttonSave = (ButtonWidget)this.addButton(new ButtonWidget(this.width / 2 + 4 + 100, 185, 50, 20, new TranslatableText("structure_block.button.save"), (buttonWidget) -> {
      ...
      this.buttonLoad = (ButtonWidget)this.addButton(new ButtonWidget(this.width / 2 + 4 + 100, 185, 50, 20, new TranslatableText("structure_block.button.load"), (buttonWidget) -> {
      ...
      this.buttonMode = (ButtonWidget)this.addButton(new ButtonWidget(this.width / 2 - 4 - 150, 185, 50, 20, new LiteralText("MODE"), (buttonWidget) -> {
         this.structureBlock.cycleMode();
         this.updateMode();
      }));
      this.buttonDetect = (ButtonWidget)this.addButton(new ButtonWidget(this.width / 2 + 4 + 100, 120, 50, 20, new TranslatableText("structure_block.button.detect_size"), (buttonWidget) -> {
         if (this.structureBlock.getMode() == StructureBlockMode.SAVE) {
      ...
      this.buttonEntities = (ButtonWidget)this.addButton(new ButtonWidget(this.width / 2 + 4 + 100, 160, 50, 20, new LiteralText("ENTITIES"), (buttonWidget) -> {
         this.structureBlock.setIgnoreEntities(!this.structureBlock.shouldIgnoreEntities());
         this.updateIgnoreEntitiesButton();
      }));
      this.buttonMirror = (ButtonWidget)this.addButton(new ButtonWidget(this.width / 2 - 20, 185, 40, 20, new LiteralText("MIRROR"), (buttonWidget) -> {
      ...
      this.buttonShowAir = (ButtonWidget)this.addButton(new ButtonWidget(this.width / 2 + 4 + 100, 80, 50, 20, new LiteralText("SHOWAIR"), (buttonWidget) -> {
         this.structureBlock.setShowAir(!this.structureBlock.shouldShowAir());
         this.updateShowAirButton();
      }));
      this.buttonShowBoundingBox = (ButtonWidget)this.addButton(new ButtonWidget(this.width / 2 + 4 + 100, 80, 50, 20, new LiteralText("SHOWBB"), (buttonWidget) -> {
         this.structureBlock.setShowBoundingBox(!this.structureBlock.shouldShowBoundingBox());
         this.updateShowBoundingBoxButton();
      }));
      this.buttonRotate0 = (ButtonWidget)this.addButton(new ButtonWidget(this.width / 2 - 1 - 40 - 1 - 40 - 20, 185, 40, 20, new LiteralText("0"), (buttonWidget) -> {
         this.structureBlock.setRotation(BlockRotation.NONE);
         this.updateRotationButton();
      }));
      this.buttonRotate90 = (ButtonWidget)this.addButton(new ButtonWidget(this.width / 2 - 1 - 40 - 20, 185, 40, 20, new LiteralText("90"), (buttonWidget) -> {
         this.structureBlock.setRotation(BlockRotation.CLOCKWISE_90);
         this.updateRotationButton();
      }));
      this.buttonRotate180 = (ButtonWidget)this.addButton(new ButtonWidget(this.width / 2 + 1 + 20, 185, 40, 20, new LiteralText("180"), (buttonWidget) -> {
         this.structureBlock.setRotation(BlockRotation.CLOCKWISE_180);
         this.updateRotationButton();
      }));
      this.buttonRotate270 = (ButtonWidget)this.addButton(new ButtonWidget(this.width / 2 + 1 + 40 + 1 + 20, 185, 40, 20, new LiteralText("270"), (buttonWidget) -> {
