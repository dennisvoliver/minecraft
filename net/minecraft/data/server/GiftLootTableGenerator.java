...
public class GiftLootTableGenerator implements Consumer<BiConsumer<Identifier, LootTable.Builder>> {
   public void accept(BiConsumer<Identifier, LootTable.Builder> biConsumer) {
      ...
      biConsumer.accept(LootTables.HERO_OF_THE_VILLAGE_FLETCHER_GIFT_GAMEPLAY, LootTable.builder().pool(LootPool.builder().rolls(ConstantLootTableRange.create(1)).with(ItemEntry.builder(Items.ARROW).weight(26)).with(ItemEntry.builder(Items.TIPPED_ARROW).apply(SetCountLootFunction.builder(UniformLootTableRange.between(0.0F, 1.0F))).apply(SetNbtLootFunction.builder((CompoundTag)Util.make(new CompoundTag(), (compoundTag) -> {
         compoundTag.putString("Potion", "minecraft:swiftness");
      })))).with(ItemEntry.builder(Items.TIPPED_ARROW).apply(SetCountLootFunction.builder(UniformLootTableRange.between(0.0F, 1.0F))).apply(SetNbtLootFunction.builder((CompoundTag)Util.make(new CompoundTag(), (compoundTag) -> {
