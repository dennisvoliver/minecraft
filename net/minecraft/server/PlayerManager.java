...
public abstract class PlayerManager {
   ...
   public void onPlayerConnect(ClientConnection connection, ServerPlayerEntity player) {
      ...
      LOGGER.info((String)"{}[{}] logged in with entity id {} at ({}, {}, {})", (Object)player.getName().getString(), string2, player.getEntityId(), player.getX(), player.getY(), player.getZ());
   ...
   public ServerPlayerEntity createPlayer(GameProfile profile) {
      ...
      if (this.server.isDemo()) {
         serverPlayerInteractionManager2 = new DemoServerPlayerInteractionManager(serverWorld);
      } else {
         serverPlayerInteractionManager2 = new ServerPlayerInteractionManager(serverWorld);
      }

      return new ServerPlayerEntity(this.server, serverWorld, profile, (ServerPlayerInteractionManager)serverPlayerInteractionManager2);
   }
   ...
   public ServerPlayerEntity respawnPlayer(ServerPlayerEntity player, boolean alive) {
      ...
      ServerPlayerEntity serverPlayerEntity = new ServerPlayerEntity(this.server, serverWorld2, player.getGameProfile(), (ServerPlayerInteractionManager)serverPlayerInteractionManager2);
      ...
      Iterator var11 = player.getScoreboardTags().iterator();
