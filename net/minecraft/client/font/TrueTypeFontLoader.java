...
public class TrueTypeFontLoader implements FontLoader {
   ...
   public Font load(ResourceManager manager) {
      ...
      try {
         ...
         TrueTypeFont var6;
         try {
            LOGGER.debug((String)"Loading font {}", (Object)this.filename);
            sTBTTFontinfo = STBTTFontinfo.malloc();
            byteBuffer = TextureUtil.readAllToByteBuffer(resource.getInputStream());
            byteBuffer.flip();
            LOGGER.debug((String)"Reading font {}", (Object)this.filename);
         ...
         LOGGER.error((String)"Couldn't load truetype font {}", (Object)this.filename, (Object)var18);
