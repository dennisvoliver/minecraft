...
public class VillagerEntity extends MerchantEntity implements InteractionObserver, VillagerDataContainer {
   ...
   public void onDeath(DamageSource source) {
      LOGGER.info((String)"Villager {} died, message: '{}'", (Object)this, (Object)source.getDeathMessage(this).getString());
   ...
   public VillagerEntity createChild(ServerWorld serverWorld, PassiveEntity passiveEntity) {
      ...
      VillagerEntity villagerEntity = new VillagerEntity(EntityType.VILLAGER, serverWorld, villagerType3);
      villagerEntity.initialize(serverWorld, serverWorld.getLocalDifficulty(villagerEntity.getBlockPos()), SpawnReason.BREEDING, (EntityData)null, (CompoundTag)null);
      return villagerEntity;
   }

   public void onStruckByLightning(ServerWorld world, LightningEntity lightning) {
      if (world.getDifficulty() != Difficulty.PEACEFUL) {
         LOGGER.info((String)"Villager {} was struck by lightning {}.", (Object)this, (Object)lightning);
         ...
         witchEntity.initialize(world, world.getLocalDifficulty(witchEntity.getBlockPos()), SpawnReason.CONVERSION, (EntityData)null, (CompoundTag)null);
   ...
   private int getAvailableFood() {
      ...
      return ITEM_FOOD_VALUES.entrySet().stream().mapToInt((entry) -> {
         return simpleInventory.count((Item)entry.getKey()) * (Integer)entry.getValue();
      }).sum();
   }
   ...
   private IronGolemEntity spawnIronGolem(ServerWorld world) {
      ...
      for(int i = 0; i < 10; ++i) {
         ...
         if (blockPos2 != null) {
            IronGolemEntity ironGolemEntity = (IronGolemEntity)EntityType.IRON_GOLEM.create(world, (CompoundTag)null, (Text)null, (PlayerEntity)null, blockPos2, SpawnReason.MOB_SUMMONED, false, false);
            if (ironGolemEntity != null) {
   ...
   static {
      ...
      }, MemoryModuleType.POTENTIAL_JOB_SITE, (villagerEntity, pointOfInterestType) -> {
         return PointOfInterestType.IS_USED_BY_PROFESSION.test(pointOfInterestType);
