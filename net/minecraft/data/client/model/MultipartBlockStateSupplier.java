...
public class MultipartBlockStateSupplier implements BlockStateSupplier {
   ...
   public MultipartBlockStateSupplier with(BlockStateVariant blockStateVariant) {
      return this.with((List)ImmutableList.of(blockStateVariant));
   }
   ...
   public MultipartBlockStateSupplier with(When when, BlockStateVariant... blockStateVariants) {
      return this.with(when, (List)ImmutableList.copyOf((Object[])blockStateVariants));
   }

   public MultipartBlockStateSupplier with(When when, BlockStateVariant blockStateVariant) {
      return this.with(when, (List)ImmutableList.of(blockStateVariant));
   }
