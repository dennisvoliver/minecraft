...
public class BlockEntityBlockStateFix extends ChoiceFix {
   ...
   protected Typed<?> transform(Typed<?> inputType) {
      ...
      Typed<?> typed = (Typed)type.pointTyped(inputType.getOps()).orElseThrow(() -> {
         return new IllegalStateException("Could not create new piston block entity.");
      });
      return typed.set(DSL.remainderFinder(), (Object)dynamic).set(opticFinder, (Typed)((Pair)type2.readTyped(dynamic2).result().orElseThrow(() -> {
