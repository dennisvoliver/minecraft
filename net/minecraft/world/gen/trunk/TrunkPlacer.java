...
public abstract class TrunkPlacer {
   ...
   protected static <P extends TrunkPlacer> P3<Mu<P>, Integer, Integer, Integer> method_28904(Instance<P> instance) {
      return instance.group(Codec.intRange(0, 32).fieldOf("base_height").forGetter((trunkPlacer) -> {
         ...
         return trunkPlacer.firstRandomHeight;
      }), Codec.intRange(0, 24).fieldOf("height_rand_b").forGetter((trunkPlacer) -> {
         return trunkPlacer.secondRandomHeight;
      }));
   }
   ...
   static {
      CODEC = Registry.TRUNK_PLACER_TYPE.dispatch(TrunkPlacer::getType, TrunkPlacerType::getCodec);
   }
}
