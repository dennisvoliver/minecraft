...
public class VariantSettings {
   public static final VariantSetting<VariantSettings.Rotation> X = new VariantSetting("x", (rotation) -> {
      return new JsonPrimitive(rotation.degrees);
   });
   public static final VariantSetting<VariantSettings.Rotation> Y = new VariantSetting("y", (rotation) -> {
      return new JsonPrimitive(rotation.degrees);
   });
