...
public abstract class Sensor<E extends LivingEntity> {
   ...
   private static final TargetPredicate field_26630 = (new TargetPredicate()).setBaseMaxDistance(16.0D).includeTeammates().ignoreEntityTargetRules();
   private static final TargetPredicate field_26631 = (new TargetPredicate()).setBaseMaxDistance(16.0D).includeTeammates().ignoreEntityTargetRules().ignoreDistanceScalingFactor();
   ...
   protected static boolean method_30954(LivingEntity livingEntity, LivingEntity livingEntity2) {
      return livingEntity.getBrain().method_29519(MemoryModuleType.ATTACK_TARGET, livingEntity2) ? field_26631.test(livingEntity, livingEntity2) : field_26630.test(livingEntity, livingEntity2);
   }
}
