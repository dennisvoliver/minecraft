...
public class DamageSource {
   ...
   public static DamageSource fireball(AbstractFireballEntity fireball, @Nullable Entity attacker) {
      return attacker == null ? (new ProjectileDamageSource("onFire", fireball, fireball)).setFire().setProjectile() : (new ProjectileDamageSource("fireball", fireball, attacker)).setFire().setProjectile();
   }
