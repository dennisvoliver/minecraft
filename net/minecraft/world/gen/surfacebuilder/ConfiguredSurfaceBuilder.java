...
public class ConfiguredSurfaceBuilder<SC extends SurfaceConfig> {
   public static final Codec<ConfiguredSurfaceBuilder<?>> CODEC;
   public static final Codec<Supplier<ConfiguredSurfaceBuilder<?>>> REGISTRY_CODEC;
   ...
   static {
      CODEC = Registry.SURFACE_BUILDER.dispatch((configuredSurfaceBuilder) -> {
         return configuredSurfaceBuilder.surfaceBuilder;
      }, SurfaceBuilder::getCodec);
      REGISTRY_CODEC = RegistryElementCodec.of(Registry.CONFIGURED_SURFACE_BUILDER_WORLDGEN, CODEC);
   }
}
