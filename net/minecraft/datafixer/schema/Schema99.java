...
public class Schema99 extends Schema {
   ...
   public Map<String, Supplier<TypeTemplate>> registerEntities(Schema schema) {
      ...
      schema.register(map, "Item", (Function)((string) -> {
      ...
      schema.register(map, "Arrow", (Function)((string) -> {
         return DSL.optionalFields("inTile", TypeReferences.BLOCK_NAME.in(schema));
      }));
      schema.register(map, "TippedArrow", (Function)((string) -> {
         return DSL.optionalFields("inTile", TypeReferences.BLOCK_NAME.in(schema));
      }));
      schema.register(map, "SpectralArrow", (Function)((string) -> {
         return DSL.optionalFields("inTile", TypeReferences.BLOCK_NAME.in(schema));
      }));
      ...
      schema.register(map, "ThrownPotion", (Function)((string) -> {
      ...
      schema.register(map, "Enderman", (Function)((string) -> {
      ...
      schema.register(map, "EntityHorse", (Function)((string) -> {
      ...
      schema.register(map, "Villager", (Function)((string) -> {
   ...
   public Map<String, Supplier<TypeTemplate>> registerBlockEntities(Schema schema) {
      ...
      schema.register(map, "RecordPlayer", (Function)((string) -> {
      ...
      schema.register(map, "MobSpawner", (Function)((string) -> {
      ...
      schema.register(map, "FlowerPot", (Function)((string) -> {
   ...
   protected static <T> T method_5359(Dynamic<T> dynamic, Map<String, String> map, String string) {
      return dynamic.update("tag", (dynamic2) -> {
         return dynamic2.update("BlockEntityTag", (dynamic2x) -> {
            ...
            if (string2 == null) {
               LOGGER.warn((String)"Unable to resolve BlockEntity for ItemStack: {}", (Object)string);
               return dynamic2x;
            } else {
            ...
            return Objects.equals(IdentifierNormalizingSchema.normalize(string2), "minecraft:armor_stand") ? dynamic2x.set("id", dynamic.createString(string)) : dynamic2x;
         });
      }).getValue();
   }
}
