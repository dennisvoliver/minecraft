...
public class RepeatedNarrator {
   ...
   public void narrate(String message) {
      RepeatedNarrator.Parameters parameters = (RepeatedNarrator.Parameters)this.params.updateAndGet((parametersx) -> {
         return parametersx != null && message.equals(parametersx.message) ? parametersx : new RepeatedNarrator.Parameters(message, RateLimiter.create((double)this.permitsPerSecond));
      });
