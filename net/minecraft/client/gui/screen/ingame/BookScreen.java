...
public class BookScreen extends Screen {
   ...
   public static class WrittenBookContents implements BookScreen.Contents {
      ...
      private static List<String> getPages(ItemStack stack) {
         CompoundTag compoundTag = stack.getTag();
         return (List)(compoundTag != null && WrittenBookItem.isValid(compoundTag) ? BookScreen.readPages(compoundTag) : ImmutableList.of(Text.Serializer.toJson((new TranslatableText("book.invalid.tag")).formatted(Formatting.DARK_RED))));
      }
