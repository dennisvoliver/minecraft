...
public class SpectatorMenuState {
   ...
   public SpectatorMenuCommand getCommand(int slot) {
      return slot >= 0 && slot < this.commands.size() ? (SpectatorMenuCommand)MoreObjects.firstNonNull(this.commands.get(slot), SpectatorMenu.BLANK_COMMAND) : SpectatorMenu.BLANK_COMMAND;
   }
