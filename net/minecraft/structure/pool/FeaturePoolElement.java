...
public class FeaturePoolElement extends StructurePoolElement {
   public static final Codec<FeaturePoolElement> CODEC = RecordCodecBuilder.create((instance) -> {
      return instance.group(ConfiguredFeature.REGISTRY_CODEC.fieldOf("feature").forGetter((featurePoolElement) -> {
         return featurePoolElement.feature;
      }), method_28883()).apply(instance, (BiFunction)(FeaturePoolElement::new));
   });
