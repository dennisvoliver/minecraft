...
public class TheEndBiomeSource extends BiomeSource {
   public static final Codec<TheEndBiomeSource> CODEC = RecordCodecBuilder.create((instance) -> {
      ...
      })).apply(instance, (App)instance.stable(TheEndBiomeSource::new));
   });
   ...
   public TheEndBiomeSource(Registry<Biome> biomeRegistry, long seed) {
      this(biomeRegistry, seed, (Biome)biomeRegistry.getOrThrow(BiomeKeys.THE_END), (Biome)biomeRegistry.getOrThrow(BiomeKeys.END_HIGHLANDS), (Biome)biomeRegistry.getOrThrow(BiomeKeys.END_MIDLANDS), (Biome)biomeRegistry.getOrThrow(BiomeKeys.SMALL_END_ISLANDS), (Biome)biomeRegistry.getOrThrow(BiomeKeys.END_BARRENS));
   }
   ...
   private TheEndBiomeSource(Registry<Biome> biomeRegistry, long seed, Biome centerBiome, Biome highlandsBiome, Biome midlandsBiome, Biome smallIslandsBiome, Biome barrensBiome) {
      super((List)ImmutableList.of(centerBiome, highlandsBiome, midlandsBiome, smallIslandsBiome, barrensBiome));
