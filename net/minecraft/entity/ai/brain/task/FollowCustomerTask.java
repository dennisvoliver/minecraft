...
public class FollowCustomerTask extends Task<VillagerEntity> {
   ...
   private void update(VillagerEntity villager) {
      ...
      brain.remember(MemoryModuleType.WALK_TARGET, (Object)(new WalkTarget(new EntityLookTarget(villager.getCurrentCustomer(), false), this.speed, 2)));
      brain.remember(MemoryModuleType.LOOK_TARGET, (Object)(new EntityLookTarget(villager.getCurrentCustomer(), true)));
   }
}
