...
public abstract class BlockStateVariantMap {
   ...
   private void checkAllPropertyDefinitions() {
      ...
      for(Iterator var3 = list.iterator(); var3.hasNext(); stream = stream.flatMap((propertiesMap) -> {
         ...
         return var10000.map(propertiesMap::method_25819);
      })) {
         property = (Property)var3.next();
      }

      List<PropertiesMap> list2 = (List)stream.filter((propertiesMap) -> {
   ...
   public static class QuintupleProperty<T1 extends Comparable<T1>, T2 extends Comparable<T2>, T3 extends Comparable<T3>, T4 extends Comparable<T4>, T5 extends Comparable<T5>> extends BlockStateVariantMap {
      ...
      public BlockStateVariantMap.QuintupleProperty<T1, T2, T3, T4, T5> register(T1 comparable, T2 comparable2, T3 comparable3, T4 comparable4, T5 comparable5, List<BlockStateVariant> list) {
      ...
      public BlockStateVariantMap.QuintupleProperty<T1, T2, T3, T4, T5> register(T1 comparable, T2 comparable2, T3 comparable3, T4 comparable4, T5 comparable5, BlockStateVariant blockStateVariant) {
   ...
   public static class QuadrupleProperty<T1 extends Comparable<T1>, T2 extends Comparable<T2>, T3 extends Comparable<T3>, T4 extends Comparable<T4>> extends BlockStateVariantMap {
      ...
      public BlockStateVariantMap.QuadrupleProperty<T1, T2, T3, T4> register(T1 comparable, T2 comparable2, T3 comparable3, T4 comparable4, List<BlockStateVariant> list) {
      ...
      public BlockStateVariantMap.QuadrupleProperty<T1, T2, T3, T4> register(T1 comparable, T2 comparable2, T3 comparable3, T4 comparable4, BlockStateVariant blockStateVariant) {
   ...
   public static class TripleProperty<T1 extends Comparable<T1>, T2 extends Comparable<T2>, T3 extends Comparable<T3>> extends BlockStateVariantMap {
      ...
      public BlockStateVariantMap register(BlockStateVariantMap.TriFunction<T1, T2, T3, BlockStateVariant> triFunction) {
         this.first.getValues().forEach((comparable) -> {
            this.second.getValues().forEach((comparable2) -> {
               this.third.getValues().forEach((comparable3) -> {
                  this.register(comparable, comparable2, comparable3, (BlockStateVariant)triFunction.apply(comparable, comparable2, comparable3));
               });
            });
         });
         return this;
   ...
   public static class DoubleProperty<T1 extends Comparable<T1>, T2 extends Comparable<T2>> extends BlockStateVariantMap {
      ...
      public BlockStateVariantMap register(BiFunction<T1, T2, BlockStateVariant> variantFactory) {
         this.first.getValues().forEach((comparable) -> {
            this.second.getValues().forEach((comparable2) -> {
               this.register(comparable, comparable2, (BlockStateVariant)variantFactory.apply(comparable, comparable2));
            });
         });
         return this;
      }
      ...
      public BlockStateVariantMap registerVariants(BiFunction<T1, T2, List<BlockStateVariant>> variantsFactory) {
         this.first.getValues().forEach((comparable) -> {
            this.second.getValues().forEach((comparable2) -> {
               this.register(comparable, comparable2, (List)variantsFactory.apply(comparable, comparable2));
            });
         });
         return this;
      }
   ...
   public static class SingleProperty<T1 extends Comparable<T1>> extends BlockStateVariantMap {
      ...
      public BlockStateVariantMap.SingleProperty<T1> register(T1 value, List<BlockStateVariant> variants) {
         ...
         this.register((PropertiesMap)propertiesMap, (List)variants);
         return this;
      }
      ...
      public BlockStateVariantMap register(Function<T1, BlockStateVariant> variantFactory) {
         this.property.getValues().forEach((comparable) -> {
            this.register(comparable, (BlockStateVariant)variantFactory.apply(comparable));
         });
         return this;
      }
   }
