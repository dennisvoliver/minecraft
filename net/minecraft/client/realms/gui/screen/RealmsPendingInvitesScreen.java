...
public class RealmsPendingInvitesScreen extends RealmsScreen {
   ...
   public void init() {
      ...
      this.acceptButton = (ButtonWidget)this.addButton(new ButtonWidget(this.width / 2 - 174, this.height - 32, 100, 20, new TranslatableText("mco.invites.button.accept"), (buttonWidget) -> {
         this.accept(this.selectedInvite);
         this.selectedInvite = -1;
         this.updateButtonStates();
      }));
      this.addButton(new ButtonWidget(this.width / 2 - 50, this.height - 32, 100, 20, ScreenTexts.DONE, (buttonWidget) -> {
         this.client.openScreen(new RealmsMainScreen(this.parent));
      }));
      this.rejectButton = (ButtonWidget)this.addButton(new ButtonWidget(this.width / 2 + 74, this.height - 32, 100, 20, new TranslatableText("mco.invites.button.reject"), (buttonWidget) -> {
