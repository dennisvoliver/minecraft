      ...
      if (itemStack.getItem() instanceof ArmorItem) {
         ...
         if (armorItem.getSlotType() == equipmentSlot) {
            ...
            if (armorItem instanceof DyeableArmorItem) {
               ...
               this.renderArmorParts(matrices, vertexConsumers, i, armorItem, bl2, bipedEntityModel, bl, f, g, h, (String)null);
               this.renderArmorParts(matrices, vertexConsumers, i, armorItem, bl2, bipedEntityModel, bl, 1.0F, 1.0F, 1.0F, "overlay");
            } else {
               this.renderArmorParts(matrices, vertexConsumers, i, armorItem, bl2, bipedEntityModel, bl, 1.0F, 1.0F, 1.0F, (String)null);
            }
